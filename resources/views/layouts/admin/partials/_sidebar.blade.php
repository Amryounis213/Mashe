            ...
            <div class="navbar-vertical-content bg--title" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('country'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/country*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.country.add') }}"
                                title="{{ translate('messages.country_setup') }}">
                                <i class="tio-poi-outlined nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{ translate('messages.country_setup') }}</span>
                            </a>
                        </li>
                    @endif
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('restaurant'))
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/restaurant*') && !Request::is('admin/restaurant/withdraw_list') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('messages.markets') }}">
                                <i class="tio-restaurant nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.markets') }}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ (Request::is('admin/markets*') && !Request::is('admin/markets/withdraw_list')) ||
                                stripos(Request()->fullurl(), 'pending-list', 5)
                                    ? 'block'
                                    : 'none' }}">
                                {{ stripos(Request()->fullurl(), 'pending-list', 5) }}
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/market/add') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.market.add') }}"
                                        title="{{ translate('messages.add_market') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{ translate('messages.add_market') }}
                                        </span>
                                    </a>
                                </li>

                                <li
                                    class="navbar-item {{ !stripos(Request()->fullurl(), 'pending-list', 5) && (Request::is('admin/market/list') || Request::is('admin/market/transcation/*') || Request::is('admin/market/view*')) ? 'active' : '' }} ">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.market.list') }}"
                                        title="{{ translate('messages.markets_list') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.markets_list') }}</span>
                                    </a>
                                </li>

                                <li
                                    class="navbar-item {{ stripos(Request()->fullurl(), 'pending-list', 5) || Request::is('admin/market/pending/list*') || Request::is('admin/market/denied/list*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.market.pending') }}"
                                        title="{{ translate('messages.New_joining_request') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.New_joining_request') }}
