                                ...
                                <div class="tab-content">
                                    <div class="form-group m-0">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ translate('messages.Country Name') }}</label>
                                        <select name="country_id" class="form-control js-select2-custom h--45px" required
                                            data-placeholder="{{ translate('messages.select_city') }}">
                                            <option value="" readonly="true" hidden="true">
                                                {{ translate('Ex:_XYZ_Country') }}</option>
                                            @foreach (\App\Models\Country::where('status', 1)->get(['id', 'name']) as $zone)
                                                {{-- @if (isset(auth('admin')->user()->country_id)) --}}
                                                    {{-- @if (auth('admin')->user()->country_id == $zone->id) --}}
                        ...
                        <table id="columnSearchDatatable"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="text-center">{{ translate('messages.categories') }}</th>
                            ...
                            <tbody id="set-rows">
                                ...
                                @foreach ($zones as $key => $zone)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('admin.zone.categories' , $zone->id)}}" class="badge badge-success">
