                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            <a class="btn btn-sm export-btn btn-outline-primary btn--primary font--sm" href="{{route('admin.restaurant.categories' , $dm->id)}}">
                                                <i class="tio-invisible"></i> {{translate('messages.show_menus')}}
                                            </a>
