...
@section('title', translate('Add_new_country'))
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">
                        <img src="{{ dynamicAsset('/public/assets/admin/img/zone.png') }}" alt="" class="mr-2">
                        {{ translate('messages.Add_New_Country') }}
                    </h1>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-5">
                            <div class="zone-setup-instructions">
                                ...
                                <div class="instructions-image mt-4">
                                    <img src={{ dynamicAsset('public/assets/admin/img/instructions.gif') }}
                                        alt="instructions">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pl-xl-5 pl-xxl-0">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="form-group mb-6 " id="code">
                                        <label class="input-label" for="code">{{ translate('messages.country_code')}} </label>
                                        <input type="text" name="code"  class="form-control" placeholder="{{translate('messages.country_code')}}" maxlength="191"   >
                                    </div>
                                    <div class="form-group mb-6 " id="currency">
                                        <label class="input-label" for="currency">{{ translate('messages.currency')}} </label>
                                        <input type="text" name="currency"  class="form-control" placeholder="{{translate('messages.currency')}}" maxlength="191"   >
                                    </div>
                    ...
                    <div class="card-header py-2 flex-wrap border-0 align-items-center">
                        <div class="search--button-wrapper">
                            <h5 class="card-title">{{ translate('messages.country_list') }}<span
                                    class="badge badge-soft-dark ml-2" id="itemCount">{{ $countries->total() }}</span>
                            </h5>
                        ...
                        <table id="columnSearchDatatable"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="text-center">{{ translate('messages.country_id') }}</th>
                                    <th class="pl-5">{{ translate('messages.name') }}</th>
                                    <th class="text-center">{{ translate('messages.code') }}</th>
                                    <th class="text-center">{{ translate('messages.currency') }}</th>
                                        ...
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm">
                                                <input type="checkbox" class="toggle-switch-input dynamic-checkbox"
                                                    id="status-{{ $country['id'] }}"
                                                    {{ $country->is_active ? 'checked' : '' }}
                                                    data-id="status-{{ $country['id'] }}" data-type="status"
                                                    ...
                                                    data-title-on="{{ translate('Want_to_activate_this_country?') }}"
                                                    data-title-off="{{ translate('Want_to_deactivate_this_country?') }}">
                                                <span class="toggle-switch-label">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </label>
                                            <form
                                                action="{{ route('admin.country.status', [$country['id'], $country->is_active ? 0 : 1]) }}"
                                                method="get" id="status-{{ $country['id'] }}_form">
                                            </form>
                                        </td>
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn btn-sm btn--primary btn-outline-primary action-btn"
                                                    ...
                                                    title="{{ translate('messages.edit_country') }}"><i
                                                        class="tio-edit"></i>
                                                </a>
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                ...
                                                <a class="btn btn-sm btn--danger btn-outline-danger action-btn form-alert"
                                                    href="javascript:" data-id="country-{{ $country['id'] }}"
                                                    data-message="{{ translate('messages.Want_to_delete_this_country') }}"
                                                    title="{{ translate('messages.delete_country') }}"><i
                                                        class="tio-delete-outlined"></i>
                                                </a>
                                                <form action="{{ route('admin.country.delete', [$country['id']]) }}"
                                                    method="post" id="country-{{ $country['id'] }}">
                                                    @csrf @method('delete')
                                                </form>
            ...
            $.post({
                ...
                success: function(data) {
                    if (data.errors) {
                        ...
                        $('#coordinates').val(null);
                        toastr.success(
                        "{{ translate('messages.New_country_Created_Successfully!') }}", {
                            CloseButton: true,
                            ProgressBar: true
                        });
