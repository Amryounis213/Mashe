    ...
    <div class="page-header">
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            <h1 class="page-header-title text-break me-2">
                <i class="tio-shop"></i> <span>{{$market->name}}</span>
            </h1>
            @if($market->vendor->status)
            <a href="{{route('admin.market.edit',[$market->id])}}" class="btn btn--primary my-2">
                <i class="tio-edit mr-2"></i> {{translate('messages.edit_market')}}
            </a>
            @else
            <div>
                @if(!isset($market->vendor->status))
                <a class="btn btn--danger text-capitalize my-2 request_alert"
                    data-url="{{route('admin.market.application',[$market['id'],0])}}" data-message="{{translate('messages.you_want_to_deny_this_application')}}"
                    href="javascript:">{{translate('messages.deny')}}</a>
                @endif
                <a class="btn btn--primary text-capitalize my-2 request_alert"
                    data-url="{{route('admin.market.application',[$market['id'],1])}}" data-message="{{translate('messages.you_want_to_approve_this_application')}}"
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
            <!-- Nav -->
            @include('admin-views.vendor.view.partials._header',['market'=>$market])
            ...
            <div class="card bg--1 h-100">
                <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                    <div class="cash--subtitle">
                        {{translate('messages.collected_cash_by_market')}}
                    </div>
                ...
                <div class="card-footer pt-0 bg-transparent">
                    <a class="btn btn-- bg--title h--45px w-100" href="{{route('admin.account-transaction.index')}}"
                        title="{{translate('messages.goto_account_transaction')}}">{{translate('messages.collect_cash_from_market')}}</a>
                </div>
            </div>
        </div>
                ...
                <div class="card mt-2">
                    <div class="card-header">
                        <h5 class="card-title m-0 d-flex align-items-center">
                            ...
                            <span class="ml-1">{{translate('messages.market_info')}}</span>
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row align-items-center g-3">
                            <div class="col-lg-6">
                                <div class="resturant--info-address">
                                    <div class="logo">
                                        <img class="onerror-image" data-onerror-image="{{dynamicAsset('public/assets/admin/img/100x100/market-default-image.png')}}"
                                    ...
                                    <ul class="address-info list-unstyled list-unstyled-py-3 text-dark">
                                        ...
                                        <li>
                                            ...
                                            <span class="pl-1">
                                                {{translate('messages.address')}} : {{$market->address}}
                                            </span>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <span class="pl-1">
                                                {{translate('messages.phone')}} : {{$market->phone}}
                                            </span>
                                        </li>
                                        <li>
                                            <i class="tio-email nav-icon"></i>
                                            <span class="pl-1">
                                                {{translate('messages.email')}} : {{$market->email}}
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="card-body d-flex flex-column justify-content-center">
                        <div class="resturant--info-address">
                            ...
                            <ul class="address-info address-info-2 list-unstyled list-unstyled-py-3 text-dark">
                                <li>
                                    <h5 class="name">
                                        {{$market->vendor->f_name}} {{$market->vendor->l_name}}
                                    </h5>
                                </li>
                                <li>
                                    <i class="tio-call-talking nav-icon"></i>
...
{{--                            @if($market->vendor->bank_name)--}}
{{--                            <li class="pb-1 pt-1">--}}
{{--                                <strong class="text--title">{{translate('messages.bank_name')}}:</strong>--}}
{{--                                {{$market->vendor->bank_name ? $market->vendor->bank_name : 'No Data found'}}--}}
{{--                            </li>--}}
{{--                            <li class="pb-1 pt-1">--}}
{{--                                <strong class="text--title">{{translate('messages.branch')}} :</strong>--}}
{{--                                {{$market->vendor->branch ? $market->vendor->branch : 'No Data found'}}--}}
{{--                            </li>--}}
{{--                            <li class="pb-1 pt-1">--}}
{{--                                <strong class="text--title">{{translate('messages.holder_name')}} :</strong>--}}
{{--                                {{$market->vendor->holder_name ? $market->vendor->holder_name : 'No Data--}}
{{--                                found'}}--}}
{{--                            </li>--}}
{{--                            <li class="pb-1 pt-1">--}}
{{--                                <strong class="text--title">{{translate('messages.account_no')}} :</strong>--}}
{{--                                {{$market->vendor->account_no ? $market->vendor->account_no : 'No Data found'}}--}}
{{--                            </li>--}}
{{--                            @else--}}
{{--                            <li class="my-auto">--}}
...
{{--            </div>--}}
                ...
                <div class="card h-100">
                    <div class="card-header">
                        <h5 class="card-title m-0 d-flex align-items-center">
                            ...
                            <span class="ml-1">{{translate('messages.market_Model')}} : {{
                                translate($market->market_model ?? 'None') }}</span>
                        </h5>
                    </div>
                    <div class="card-body d-flex flex-column justify-content-center">
                        <div class="resturant--info-address">
                            ...
                            <ul class="address-info address-info-2 list-unstyled list-unstyled-py-3 text-dark">
                                ...
                                <li>
                                    <span class="pl-1">
                                        ...
                                        {{$market->market_sub->package->package_name}}
                                    </span>
                                </li>
                                <li>
                                <li>
                                    <span class="pl-1">
                                        ...
                                        {{\App\CentralLogics\Helpers::format_currency($market->market_sub->package->price)}}
                                    </span>
                                </li>
                                <li>
                                    <span class="pl-1">
                                        {{ translate('messages.Expire_Date') }} :
                                        {{$market->market_sub->expiry_date->format('d M Y')}}
                                    </span>
                                </li>
                                <li>
                                    @if ($market->market_sub->status == 1)
                                ...
                                @elseif(!isset($market->market_sub) && $market->market_model ==
                                'unsubscribed' )
                                <li>
                                    <span class="pl-1">
        ...
        @if($market->additional_data && count(json_decode($market->additional_data, true)) > 0 )
            <div class="row">
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <div class="__registration-information">
                            <div class="item">
                                <ul>
                                    @foreach (json_decode($market->additional_data, true) as $key => $item)
                                        @if (is_array($item))
            ...
            @if($market->additional_documents && count(json_decode($market->additional_documents, true)) > 0 )
            <div class="col-lg-12  mt-2">
                <div class="card ">
                    <div class="card-header justify-content-between align-items-center">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-4 align-items-start">
                                @foreach (json_decode($market->additional_documents, true) as $key => $item)
...
<script>
    ...
    const myLatLng = { lat: {{$market->latitude}}, lng: {{$market->longitude}} };
        let map;
        initMap();
        function initMap() {
