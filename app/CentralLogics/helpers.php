...
class Helpers
{
    ...
    public static function cart_product_data_formatting($data, $selected_variation, $selected_addons, $selected_addon_quantity,$trans = false, $local = 'en')
    {
        ...
        $variations = [];
        $categories = [];
        $selected_addons = ($selected_addons) ? $selected_addons : [] ;
        $selected_addon_quantity = ($selected_addon_quantity) ? $selected_addon_quantity : [] ;
...
//        }
    ...
    public static function get_market_id()
    {
        if (auth('vendor_employee')->check()) {
            return auth('vendor_employee')->user()->restaurant->id;
        }
