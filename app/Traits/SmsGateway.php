...
trait  SmsGateway
{
    ...
    {
        $config = self::get_settings('InforSms');
        return self::InforSms($receiver, $otp);
    ...
    public static function SendSMS($message_text, $recepients)
    {
        $sms_user = env('INFOR_SMS_USERNAME'); // User Name (Provided by Inforu)
        $sms_apitoken =env('INFOR_SMS_TOKEN'); ; // Password (Provided by Inforu)
        $sms_sender = "mashe"; // 
        ...
        // ?UserName=string&ApiToken=string&SenderCellNumber=string&CellNumber=string&MessageString=string&IgnoreUnsubscribeCheck=boolean

        // $response = Http::post('https://api.inforu.co.il/inforufrontend/WebInterface/SendMessageByNumber.aspx', [
        //     'UserName' => $username,
        //     'ApiToken' => $apiToken,
        //     'SenderCellNumber' => $senderCellNumber,
        //     'CellNumber' => $cellNumber,
        //     'MessageString' => $messageString,
        //     'IgnoreUnsubscribeCheck'=>$ignoreUnsubscribeCheck,
        // ]);
        // dd($response->body()); // Or handle the response as needed
    }
}
