...
class VendorController extends Controller
{
    ...
    public function categories($id)
    {
        ...
        $restaurant = Restaurant::findorfail($id);
        $categories = ParentCategory::with(['Foods' => function($qu){
        ...
        return view('admin-views.vendor.view.menus' , compact('categories' , 'restaurant'));
    }
    public function create_category_page($restaurant_id)
    {
        return view('admin-views.vendor.view.add-new-menu' , compact('restaurant_id'));
    }
    public function add_new_category(Request $request)
    {
        ...
        $menu->parentable_id= $request->restaurant_id ;
        $menu->parentable_type = Restaurant::class ;
        $menu->save();
        ...
        return redirect()->route('admin.restaurant.categories' , $request->restaurant_id);
    }
