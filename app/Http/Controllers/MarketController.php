...
class MarketController extends Controller
{
    public function create()
    {
        ...
        return view('market-views.auth.register-step-1',compact('page_data')) ;
    }
    ...
    public function store(Request $request)
    {
        ...
        Translation::insert($data);
            ...
            if (Helpers::subscription_check()) {
                ...
                return view('market-views.auth.register-step-2',[
                ...
                return view('market-views.auth.register-step-4',[
    ...
    public function business_plan(Request $request){
            ...
            if ($request->business_plan == 'subscription-base' && $request->package_id != null ) {
                return view('market-views.auth.register-step-3',[
