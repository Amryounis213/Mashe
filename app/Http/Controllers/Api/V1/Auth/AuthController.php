...
class AuthController extends Controller
{
    ...
    public function verify_phone(Request $request)
    {
        ...
        if ($user) {
            ...
            //     return $this->SuccessApi(null, translate('messages.phone_number_is_already_varified'));
            // }
            ...
            if ($data) {
                ...
                $user->save();
                return $this->SuccessApi($user->setAttribute('token', $token), translate('messages.phone_number_varified_successfully'));
            } else {
