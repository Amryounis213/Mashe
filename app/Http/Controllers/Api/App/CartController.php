...
use App\Http\Resources\Api\Carts\CartResource as CartsCartResource;
...
class CartController extends Controller
{
    ...
    public function get_carts(Request $request)
    {
        ...
        $cartInfo = CartResult::where('user_id' , auth('api')->id())->first();

        $data = [
            'subtotal' => $cartInfo->subtotal,
            'discount' => $cartInfo->discount,
            'tax' => $cartInfo->tax,
            'distance' => $cartInfo ->distance,
            'fees' => $cartInfo->fees,
            'delivery_fee' => $cartInfo ->delivery_fee,
            'delivery_tip' => $cartInfo ->delivery_tip,
    ...
    public function add_to_cart(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'guest_id' => auth('api')->id() ? 'nullable' : 'required',
        ...
        // return json_encode($request->add_on_ids);
        $cart = new Cart();
        ...
        $cart->variations = json_encode($request?->variation_options ?? []);
