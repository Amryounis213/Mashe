...
class Market extends Model
{
    ...
    {
        return $this->belongsToMany(Tag::class , 'markets_tag' , 'markets_id' , 'tag_id' , 'id' , 'id');
    }
    ...
    {
        return $this->belongsTo(MarketVendor::class , 'vendor_id' , 'id');
    }
    ...
    {
        return $this->hasManyThrough(MarketReviews::class, Food::class);
    }
    ...
    public function scopeMarketModel($query, $type)
    {
        if($type == 'commission')
        {
            return $query->where('market_model', 'commission');
        }
        else if($type == 'subscribed')
        {
            return $query->where('market_model', 'subscription');
        }
        else if($type == 'unsubscribed')
        {
            return $query->where('market_model', 'unsubscribed');
        }
        else if($type == 'none')
        {
            return $query->where('market_model', 'none');
        }
        return $query;
    }
