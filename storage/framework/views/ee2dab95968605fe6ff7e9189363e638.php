        ...
        <div class="page-header">
            <h1 class="page-header-title mb-2 text-capitalize">
                <div class="card-header-icon d-inline-flex mr-2 img">
                    <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/orders.png')); ?>" alt="public">
                </div>
                <span>
                    ...
                    <form  class="my-2 ml-auto mr-sm-2 mr-xl-4 ml-sm-auto flex-grow-1 flex-grow-sm-0">
                        ...
                        <div class="input--group input-group input-group-merge input-group-flush">
                            <input id="datatableSearch_" type="search" name="search" class="form-control" value="<?php echo e(request()?->search ?? null); ?>"
                                    placeholder="<?php echo e(translate('messages.Ex:_Search your order...')); ?>" aria-label="<?php echo e(translate('messages.search')); ?>" >
                    ...
                    <!-- Unfold -->
                            ...
                            <div class="select-item">
                                <select name="slist" class="form-control js-select2-custom refund-filter">
                                    <option <?php echo e(($status=='requested')?'selected':''); ?> value="<?php echo e(route('admin.refund.refund_attr', ['requested'])); ?>"><?php echo e(translate('messages.Refund_Requests')); ?></option>
            ...
            <div class="table-responsive datatable-custom fz--14px">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th class="table-column-pl-0 w-90px"><?php echo e(translate('messages.Order_ID')); ?></th>
                        <th class="w-140px"><?php echo e(translate('messages.order_date')); ?></th>
                        <th class="w-130px"><?php echo e(translate('messages.customer_information')); ?></th>
                        <th class="w-140px"><?php echo e(translate('messages.restaurant')); ?></th>
                        <th class="w-120px"><?php echo e(translate('messages.total_amount')); ?></th>
                        <th class="text-center w-120px"><?php echo e(translate('messages.order_status')); ?></th>
                        <th class="text-center w-100px"><?php echo e(translate('messages.actions')); ?></th>
                    </tr>
                    </thead>
                    ...
                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="status-<?php echo e($order['order_status']); ?> class-all">
                            ...
                            <td>
                                <label class="m-0">
                                    <a href="<?php echo e(route('admin.restaurant.view', $order->restaurant_id)); ?>" class="text--title" alt="view restaurant">
                                        <?php echo e(Str::limit($order->restaurant?$order->restaurant->name:translate('messages.Restaurant_deleted!'),20,'...')); ?>
            ...
            <div class="card card-lg sidebar-card sidebar-footer-fixed">
                ...
                <form class="card-body sidebar-body sidebar-scrollbar" action="<?php echo e(route('admin.order.filter')); ?>" method="POST" id="order_filter_form">
                    ...
                    <div class="mb-2 initial-36">
                        ...
                        <?php $__currentLoopData = \App\Models\Zone::orderBy('name')->get(['id','name']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($zone->id); ?>" <?php echo e(isset($zone_ids)?(in_array($zone->id, $zone_ids)?'selected':''):''); ?>><?php echo e($zone->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <hr class="my-4">
                    <small class="text-cap mb-3"><?php echo e(translate('messages.restaurant')); ?></small>
                    <div class="mb-2 initial-36">
                        <select name="vendor[]" id="vendor_ids" class="form-control js-select2-custom" multiple="multiple">
                        <?php $__currentLoopData = \App\Models\Restaurant::whereIn('id', $vendor_ids)->get(['id','name']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restaurant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                buttons: [
                    {
                        ...
                        {
                            window.location.href = '<?php echo e(route("admin.order.export",['status'=>$status,'type'=>'excel' , request()->getQueryString() ])); ?>';
                        }
                    },
                    {
                        extend: 'csv',
                        ...
                        action: function (e, dt, node, config)
                        {
                            window.location.href = '<?php echo e(route("admin.order.export",['status'=>$status,'type'=>'csv' ,request()->getQueryString() ])); ?>';
                        }
                    },
                ],
                select: {
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/order/list.blade.php ENDPATH**/ ?>