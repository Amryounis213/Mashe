                                ...
                                <div class="tab-content">
                                    <div class="form-group m-0">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(translate('messages.Country Name')); ?></label>
                                        <select name="country_id" class="form-control js-select2-custom h--45px" required
                                            data-placeholder="<?php echo e(translate('messages.select_city')); ?>">
                                            <option value="" readonly="true" hidden="true">
                                                <?php echo e(translate('Ex:_XYZ_Country')); ?></option>
                                            <?php $__currentLoopData = \App\Models\Country::where('status', 1)->get(['id', 'name']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card">
                    <div class="card-header py-2 flex-wrap border-0 align-items-center">
                        <div class="search--button-wrapper">
                            <h5 class="card-title"><?php echo e(translate('messages.zone_list')); ?><span
                                    class="badge badge-soft-dark ml-2" id="itemCount"><?php echo e($zones->total()); ?></span></h5>
                            ...
                            <div class="hs-unfold ml-3">
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <a target="__blank" id="export-excel" class="dropdown-item"
                                        href="<?php echo e(route('admin.zone.export-zones', ['type' => 'excel', request()->getQueryString()])); ?>">
                                    ...
                                    <a target="__blank" id="export-csv" class="dropdown-item"
                                        href="<?php echo e(route('admin.zone.export-zones', ['type' => 'csv', request()->getQueryString()])); ?>">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                        ...
                        <table id="columnSearchDatatable"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="text-center"><?php echo e(translate('messages.categories')); ?></th>
                            ...
                            <tbody id="set-rows">
                                ...
                                <?php $__currentLoopData = $zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="<?php echo e(route('admin.zone.categories' , $zone->id)); ?>" class="badge badge-success">
                                            <span class="move-center">
                                                <?php echo e($zone->categories_count ?? 0); ?>
                                        ...
                                        <td>
                                            ...
                                            <form
                                                action="<?php echo e(route('admin.zone.status', [$zone['id'], $zone->status ? 0 : 1])); ?>"
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                <a class="btn btn-sm btn--primary btn-outline-primary action-btn"
                                                    href="<?php echo e(route('admin.zone.edit', [$zone['id']])); ?>"
                                                    title="<?php echo e(translate('messages.edit_zone')); ?>"><i
                                                        class="tio-edit"></i>
                                                </a>
                                                <div class="popover-wrapper hide_data <?php echo e($non_mod == 1 ? 'active' : ''); ?> ">
                                                    <a class="btn active action-btn btn--warning btn-outline-warning"
                                                        href="<?php echo e(route('admin.zone.settings', ['id' => $zone['id']])); ?>"
                                                        title="<?php echo e(translate('messages.zone_settings')); ?>">
            ...
            $.post({
                ...
                success: function(data) {
                    if (data.errors) {
                        ...
                        $('#coordinates').val(null);
                        toastr.success(
                            "<?php echo e(translate('messages.New_Business_Zone_Created_Successfully!')); ?>", {
                                CloseButton: true,
                                ProgressBar: true
                            });
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/zone/index.blade.php ENDPATH**/ ?>