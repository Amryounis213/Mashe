                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap justify-content-around __gap-12px">
                                ...
                                <div>
                                    <div class="d-flex flex-column align-items-center gap-3 mw-100">
                                        <p class="mb-0"><?php echo e(translate('Restaurant_Cover')); ?></p>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/vendor/index.blade.php ENDPATH**/ ?>