            ...
            <div class="navbar__brand-wrapper navbar-brand-wrapper justify-content-between">
                ...
                <a class="navbar-brand d-block p-0" href="<?php echo e(route('admin.dashboard')); ?>" aria-label="Front">
                    <img class="navbar-brand-logo sidebar--logo-design"
                        src="<?php echo e(\App\CentralLogics\Helpers::onerror_image_helper($restaurant_logo, dynamicStorage('storage/app/public/business/' . $restaurant_logo), dynamicAsset('public/assets/admin/img/160x160/img2.jpg'), 'business/')); ?>"
                        alt="image">
            ...
            <div class="navbar-vertical-content bg--title" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('country')): ?>
                        <li
                            class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/country*') ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="<?php echo e(route('admin.country.add')); ?>"
                                title="<?php echo e(translate('messages.country_setup')); ?>">
                                <i class="tio-poi-outlined nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    <?php echo e(translate('messages.country_setup')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('restaurant')): ?>
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/restaurant*') && !Request::is('admin/restaurant/withdraw_list') ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="<?php echo e(translate('messages.markets')); ?>">
                                <i class="tio-restaurant nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"><?php echo e(translate('messages.markets')); ?></span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: <?php echo e((Request::is('admin/markets*') && !Request::is('admin/markets/withdraw_list')) ||
                                stripos(Request()->fullurl(), 'pending-list', 5)
                                    ? 'block'
                                    : 'none'); ?>">
                                <?php echo e(stripos(Request()->fullurl(), 'pending-list', 5)); ?>
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/market/add') ? 'active' : ''); ?>">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="<?php echo e(route('admin.market.add')); ?>"
                                        title="<?php echo e(translate('messages.add_market')); ?>">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            <?php echo e(translate('messages.add_market')); ?>
                                ...
                                <li
                                    class="navbar-item <?php echo e(!stripos(Request()->fullurl(), 'pending-list', 5) && (Request::is('admin/market/list') || Request::is('admin/market/transcation/*') || Request::is('admin/market/view*')) ? 'active' : ''); ?> ">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="<?php echo e(route('admin.market.list')); ?>"
                                        title="<?php echo e(translate('messages.markets_list')); ?>">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"><?php echo e(translate('messages.markets_list')); ?></span>
                                    </a>
                                </li>

                                <li
                                    class="navbar-item <?php echo e(stripos(Request()->fullurl(), 'pending-list', 5) || Request::is('admin/market/pending/list*') || Request::is('admin/market/denied/list*') ? 'active' : ''); ?>">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="<?php echo e(route('admin.market.pending')); ?>"
                                        title="<?php echo e(translate('messages.New_joining_request')); ?>">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"><?php echo e(translate('messages.New_joining_request')); ?>
                        ...
                        <?php if(\App\CentralLogics\Helpers::module_permission_check('customer_wallet')): ?>
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:" title="<?php echo e(translate('messages.Customer_Wallet')); ?>">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        ...
                                        <a class="nav-link "
                                            href="<?php echo e(route('admin.customer.wallet.bonus.add-new')); ?>"
                                            title="<?php echo e(translate('messages.bonus')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate text-capitalize"><?php echo e(translate('messages.bonus')); ?></span>
                        ...
                        <?php if(
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item <?php echo e(Request::is('admin/subscription/package/*') || Request::is('admin/subscription/search') || Request::is('admin/subscription/transcation/list/*') ? 'active' : ''); ?>">
                                    ...
                                    <li
                                        class="nav-item <?php echo e(Request::is('admin/subscription/list') ? 'active' : ''); ?>">
                                        <a class="nav-link "
                ...
                <li
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li
                            class="nav-item <?php echo e(Request::is('admin/business-settings/payment-method') || Request::is('admin/business-settings/sms-module') || Request::is('admin/business-settings/mail-config') || Request::is('admin/social-login/view') || Request::is('admin/business-settings/config*') || Request::is('admin/business-settings/recaptcha*') ? 'active' : ''); ?>">
                ...
                <li
                    class="navbar-vertical-aside-has-menu   <?php echo e(Request::is('admin/react-landing-page*') || Request::is('admin/landing-page*') ? 'active' : ''); ?>">
                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                    ...
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <li class="nav-item <?php echo e(Request::is('admin/landing-page*') ? 'active' : ''); ?>">
                            <a class="nav-link" href="<?php echo e(route('admin.landing_page.header')); ?>"
                        ...
                        <li class="nav-item <?php echo e(Request::is('admin/react-landing-page*') ? 'active' : ''); ?>">
                            <a class="nav-link" href="<?php echo e(route('admin.react_landing_page.react_header')); ?>"
                ...
                <li
                    class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/business-settings/react*') ? 'active' : ''); ?>">
                ...
                <?php if(\App\CentralLogics\Helpers::module_permission_check('account')): ?>
                    <li
                        ...
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                            ...
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"><?php echo e(translate('messages.restaurant')); ?>
                ...
                <?php if(\App\CentralLogics\Helpers::module_permission_check('account')): ?>
                    <li
                        ...
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                            ...
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"><?php echo e(translate('messages.delivery_man')); ?>
                ...
                <li
                    ...
                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        title="<?php echo e(translate('messages.system_addons')); ?>">
                        <i class="tio-add-circle-outlined nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/layouts/admin/partials/_sidebar.blade.php ENDPATH**/ ?>