...
?>
    ...
    <div class="content container-fluid">
            ...
            <div class="card-body">
                <div
                    ...
                    <h5 class="text-capitalize m-0">
                        ...
                        <i class="tio-info-outined" data-toggle="tooltip" title="<?php echo e(translate('You_can_turn_off/on_system-provided_landing_page')); ?>"></i>
                    </h5>
            ...
            <form id="theme_form" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <label class="text-capitalize form-label form--label mb-3">
                        ...
                        <i class="tio-info-outined" data-toggle="tooltip" title="<?php echo e(translate('You_can_upload_your_landing_page_either_using_URL_or_File_Upload')); ?>"></i>
                    </label>
                        <div class="mb-30 ">
                            ...
                            <div class="__input-tab <?php echo e($landing_integration_type == 'url'?'active':''); ?>" id="url">
                                <div class="__bg-F8F9FC-card">
                                    <div class="form-group mb-0 pb-2">
                                        ...
                                        <input type="url" placeholder="<?php echo e(translate('messages.Ex: https://stackfood-admin.6amtech.com/')); ?>" class="form-control h--45px" name="redirect_url" value="<?php echo e($redirect_url); ?>">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-6 col-md-4 col-xxl-3">
                                        <div class="card theme-card">
                                            <div class="card-body d-flex justify-content-between">
                                                ...
                                                data-id="index_page"
                                               data-message="<?php echo e(translate('Want to delete this index_page ?')); ?>"
                                                title="<?php echo e(translate('messages.delete_index_page')); ?>"><i class="tio-delete-outlined"></i>
                                            </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="__input-tab <?php echo e($landing_integration_type == 'none' ?'active':''); ?>" id="none">
                                <div class="__bg-F8F9FC-card">
                                    ...
                                    <div class="text-center max-w-595 mx-auto py-4">
                                        <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/landing-icon-2.png')); ?>" class="mb-3" alt="">
                                        <p class="m-0">
                                            <?php echo e(translate('Currently_you_are_using_Stackfood_Default_Admin_Landing_Page_Theme.')); ?>

                                            <a href="<?php echo e(route('home')); ?>" class="text--primary text-underline"><?php echo e(translate('Visit_Landing_Page')); ?></a>
                                        </p>
                                    </div>
                                    <?php else: ?>
                        ...
                        <div class="btn--container justify-content-end mt-3">
                            ...
                            <button type="button" class="btn btn--primary mb-2 zip-upload" id="update_setting"> <?php echo e(translate('Save_Information')); ?></button>
                        </div>
                    </div>
                </div>
            </form>
        ...
        <?php endif; ?>
    <form action="<?php echo e(route('admin.business-settings.business-setup.delete-custom-landing-page')); ?>" method="post" id="index_page">
                        ...
                        <div class="item">
                            <div class="mb-20">
                                <div class="text-center">
                                    <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/read-instructions.png')); ?>" alt="" class="mb-20">
                                    <h5 class="modal-title"><?php echo e(translate('If_you_want_to_set_up_your_own_landing_page_please_follow_tha_instructions_below')); ?></h5>
                                </div>
                                <ol type="1">
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <div class="ms-2 mt-1">
                                            <?php echo e(translate('a._Create_an_html_file_named')); ?> <b class="bg--4 text--primary-2">index.blade.php</b>    <?php echo e(translate('_and_insert_your_landing_page_design_code_and_make_a_zip_file.')); ?>
...
<script src="<?php echo e(dynamicAsset('public/assets/admin/js/view-pages/business-settings-landing-page.js')); ?>"></script>
...
$('.zip-upload').on('click', function(){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('admin.business-settings.business-setup.update-landing-setup')); ?>",
                data: formData,
                processData: false,
                contentType: false,
                xhr: function() {
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/business-settings/landing-index.blade.php ENDPATH**/ ?>