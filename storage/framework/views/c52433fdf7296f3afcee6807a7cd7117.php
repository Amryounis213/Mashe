...
<script>
    ...
    function startFCM() {
        ...
        messaging
            ...
            .then(function () {
                ...
                subscribeTokenToTopic(response, "restaurant_panel_<?php echo e($restaurant_id); ?>_message");
    ...
    <?php if(\App\CentralLogics\Helpers::employee_module_permission_check('order') && $order_notification_type == 'manual'): ?>
        ...
        $(document).on('click', '.check-message', function () {
            location.href = '<?php echo e(url('/')); ?>/restaurant-panel/message/list';
        });
...
<?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/layouts/vendor/app.blade.php ENDPATH**/ ?>