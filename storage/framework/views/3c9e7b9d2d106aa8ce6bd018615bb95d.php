            ...
            <div class="grid-card top--rated-food pb-4 cursor-pointer redirect-url" data-url="<?php echo e(route('admin.food.view',[$item['id']])); ?>">
                <div class="text-center py-3">
                    <img class="initial-42 onerror-image"
                        ...
                        'product/'
                        )); ?>" data-onerror-image="<?php echo e(dynamicAsset('public/assets/admin/img/100x100/2.png')); ?>"
...
<!-- End Body -->
<?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/partials/_top-rated-foods.blade.php ENDPATH**/ ?>