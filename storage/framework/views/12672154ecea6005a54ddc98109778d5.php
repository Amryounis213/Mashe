            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-0 initial-19" id="conversation-list">
                        ...
                        <?php echo $__env->make('vendor-views.messages.data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <!-- End Body -->
                </div>
                <!-- End Card -->
...
<?php echo $__env->make('layouts.vendor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/vendor-views/messages/index.blade.php ENDPATH**/ ?>