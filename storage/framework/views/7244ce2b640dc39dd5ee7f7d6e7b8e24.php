        ...
        <div class="navbar-vertical-container">
            <div class="navbar-brand-wrapper justify-content-between">
                ...
                <div class="sidebar-logo-container">
                    ...
                    <a class="navbar-brand pt-0 pb-0" href="<?php echo e(route('vendor.dashboard')); ?>" aria-label="Front">
                            ...
                            src="<?php echo e(\App\CentralLogics\Helpers::onerror_image_helper($restaurant_data?->logo, dynamicStorage('storage/app/public/restaurant/'.$restaurant_data?->logo), dynamicAsset('public/assets/admin/img/160x160/img2.jpg'), 'restaurant/')); ?>"
                            alt="image">
            ...
            <div class="navbar-vertical-content text-capitalize bg-334257">
                        ...
                        style="display:  <?php echo e(Request::is('restaurant-panel/order*') && (Request::is('restaurant-panel/order/subscription*') == false )?'block':'none'); ?>">
                            ...
                            <li class="nav-item <?php echo e(Request::is('restaurant-panel/order/list/pending')?'active':''); ?> <?php echo $__env->yieldContent('pending'); ?>">
                                <a class="nav-link " href="<?php echo e(route('vendor.order.list',['pending'])); ?>" title="<?php echo e(translate('messages.pending')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        <?php echo e(translate('messages.pending')); ?> <?php echo e((config('order_confirmation_model') == 'restaurant' || $data)?'':translate('messages.take_away')); ?>
                                            ...
                                            <?php else: ?>
                                            <?php echo e(\App\Models\Order::where(['order_status'=>'pending','restaurant_id'=>\App\CentralLogics\Helpers::get_restaurant_id(), 'order_type'=>'take_away'])->NotDigitalOrder()->Notpos()->HasSubscriptionToday()->OrderScheduledIn(30)->count()); ?>
                                ...
                                <a class="nav-link " href="<?php echo e(route('vendor.order.list',['confirmed'])); ?>" title="<?php echo e(translate('messages.confirmed')); ?>">
                                    ...
                                    <span class="text-truncate sidebar--badge-container">
                                        <?php echo e(translate('messages.confirmed')); ?>
                                            ...
                                            <span class="badge badge-soft-success badge-pill ml-1">
                                            <?php echo e(\App\Models\Order::whereIn('order_status',['confirmed', 'accepted'])->NotDigitalOrder()->Notpos()->whereNotNull('confirmed')->where('restaurant_id', \App\CentralLogics\Helpers::get_restaurant_id())->HasSubscriptionToday()->OrderScheduledIn(30)->count()); ?>
                ...
                <!-- End DeliveryMan -->
                    ...
                    <?php if(\App\CentralLogics\Helpers::employee_module_permission_check('subscription') && \App\CentralLogics\Helpers::get_restaurant_data()->restaurant_model != 'commission'): ?>
                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('restaurant-panel/subscription*')?'active':''); ?>">
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                            href="<?php echo e(route('vendor.subscription.subscription')); ?>"
                            title="<?php echo e(translate('My Subscriptions')); ?>">
                            <i class="tio-crown nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                <?php echo e(translate('messages.My Subscriptions')); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/layouts/vendor/partials/_sidebar.blade.php ENDPATH**/ ?>