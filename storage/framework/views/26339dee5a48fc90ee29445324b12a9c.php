        ...
        <div class="row align-items-sm-center w-100">
            <div class="col-sm-6">
                <div class="text-center text-sm-right mr-sm-4 mb-5 mb-sm-0">
                    <img class="w-60 w-sm-100 mx-auto initial-61" src="<?php echo e(dynamicAsset('public/assets/admin')); ?>/svg/illustrations/think.svg" alt="Image Description">
                </div>
            </div>
...
<?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/errors/404.blade.php ENDPATH**/ ?>