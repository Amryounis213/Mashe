        ...
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="<?php echo e(route('vendor.dashboard')); ?>" aria-label="">
                         ...
                         src="<?php echo e(\App\CentralLogics\Helpers::onerror_image_helper($restaurant_logo, dynamicStorage('storage/app/public/restaurant/'.$restaurant_logo), dynamicAsset('public/assets/admin/img/160x160/img1.jpg'), 'restaurant/')); ?>"
                         alt="image">
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                    ...
                                    <div class="">
                                        ...
                                        src="<?php echo e(\App\CentralLogics\Helpers::onerror_image_helper(\App\CentralLogics\Helpers::get_loggedin_user()?->image, dynamicStorage('storage/app/public/vendor/'.\App\CentralLogics\Helpers::get_loggedin_user()?->image), dynamicAsset('public/assets/admin/img/160x160/img1.jpg'), 'vendor/')); ?>"
                                        alt="image">
...
<div class="alert __alert-2 alert-warning m-0 py-1 px-2" role="alert">
    <img class="rounded mr-1"  width="25" src="<?php echo e(dynamicAsset('/public/assets/admin/img/header_warning.png')); ?>" alt="">
    <div class="cont">
...
<?php if($Payable_Balance == 1 &&  $cash_in_hand_overflow &&  $wallet?->balance < 0 &&  $cash_in_hand_overflow_restaurant_amount < $wallet?->collected_cash): ?>
<div class="alert __alert-2 alert-warning m-0 py-1 px-2" role="alert">
    <img class="mr-1"  width="25" src="<?php echo e(dynamicAsset('/public/assets/admin/img/header_warning.png')); ?>" alt="">
    <div class="cont">
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/layouts/vendor/partials/_header.blade.php ENDPATH**/ ?>