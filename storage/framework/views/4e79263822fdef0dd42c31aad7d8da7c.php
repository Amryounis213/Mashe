                                    ...
                                    <div class="row g-3 justify-content-around">
                                        <div class="col-sm-6">
                                            ...
                                            <select name="zone_id"
                                                    ...
                                                    data-url="<?php echo e(url()->full()); ?>" data-filter="zone_id" id="zone_id">
                                                <option value="" selected disabled><?php echo e(translate('Select_Zone')); ?> <span>*</span>
                                                </option>
                                                <?php $__currentLoopData = Zone::active()->orderBy('name')->get(['id','name']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $z): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select name="restaurant_id"
                                                    data-url="<?php echo e(url()->full()); ?>" data-filter="restaurant_id"
                                                    data-placeholder="<?php echo e(translate('messages.select_restaurant')); ?>"
                                                    class="form-control js-select2-custom h--45x set-filter"
                                                    id="restaurant_id" disabled>

                                                <option value=""><?php echo e(translate('Select_a_restaurant')); ?></option>
                                                <?php $__currentLoopData = Restaurant::active()->orderBy('name')->where('zone_id',request('zone_id'))->get(['id','name']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $restaurant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        value="<?php echo e($restaurant['id']); ?>" <?php echo e(request('restaurant_id') && request('restaurant_id')==$restaurant->id? 'selected':''); ?>>
                                        ...
                                        <div class="col-sm-6">
                                            <select name="category" id="category"
                                                    ...
                                                    title="<?php echo e(translate('Select_Category')); ?>"
                                                    data-url="<?php echo e(url()->full()); ?>" data-filter="category_id"
                                                    disabled>
                                                <option value="" disabled selected><?php echo e(translate('Select_Categories')); ?></option>
                                                <option value="all" <?php echo e(request()?->category_id == 'all' ? 'selected' : ''); ?> ><?php echo e(translate('All_Categories')); ?></option>
                                            ...
                                            <form id="search-form" class="mw-100">
                                                <div class="input-group input-group-merge input-group-flush w-100">
                                                    ...
                                                    <input id="datatableSearch" type="search"
                                                           value="<?php echo e($keyword ?? ''); ?>" name="keyword"
                                                           class="form-control flex-grow-1 pl-5 border rounded h--45x"
                                                           placeholder="<?php echo e(translate('Ex:_Search_Food_Name')); ?>"
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="my-auto">
                                        <div class="search--no-found">
                                            <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/search-icon.png')); ?>" alt="img">
                                            <p>
                                                <?php echo e(translate('messages.Search_By_Food_Name')); ?>
                            ...
                            <div class="pos--delivery-options">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <span class="card-title-icon">
                                        ...
                                        <span><?php echo e(translate('Delivery_Information')); ?> <small>(<?php echo e(translate('Home_Delivery')); ?>)</small></span>
                                    </h5>
                                    <span class="delivery--edit-icon text-primary delivery_address_btn" data-restaurant_id="<?php echo e(request()?->restaurant_id ?? null); ?>" id="delivery_address"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body row  pt-0 ff-emoji">
                            <div id="printableArea" class="col-12">
                                <?php echo $__env->make('new_invoice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
...
<?php $__env->startPush('script_2'); ?>
    <script
        src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(BusinessSetting::where('key', 'map_api_key')->first()->value); ?>&libraries=places&callback=initMap&v=3.49">
    </script>
    <script src="<?php echo e(dynamicAsset('public/assets/admin/js/view-pages/pos.js')); ?>"></script>
    <script>
        ...
        $(document).on('click', '.delivery_address_btn', function (event) {
            ...
            if($(this).data('restaurant_id') == ''  ){
                toastr.error('<?php echo e(translate('messages.Select_a_Restaurant_First')); ?>', {
                                CloseButton: true,
                                ProgressBar: true
                            });
            } else{
        ...
        $(document).on('submit', '#product_form', function (event) {
            ...
            if(document.getElementById('phone').value.length <= 4){
                    toastr.error("<?php echo e(translate('messages.Must_enter_a_valid_phone_number.')); ?>", {
                    CloseButton: true,
                    ProgressBar: true
                });
                }
        ...
        $(document).on('click', '.place-order-submit', function (event) {
            ...
            if (customer_id.value) {
                ...
                if(document.getElementById('contact_person_name').value == ''){
                    toastr.error('<?php echo e(translate('messages.contact_person_name_is_missing')); ?>', {
                    CloseButton: true,
                    ProgressBar: true
                });
                }
                    ...
                    toastr.error("<?php echo e(translate('messages.contact_person_number_is_missing')); ?>", {
                    CloseButton: true,
                    ProgressBar: true
                });
                }
                else if(document.getElementById('longitude').value == '' ||  document.getElementById('latitude').value == ''){
                    toastr.error("<?php echo e(translate('messages.longitude_&_latitude_is_missing')); ?>", {
                    CloseButton: true,
                    ProgressBar: true
                });
                }
                else if(document.getElementById('cart_food_id').value == '' ){
                    toastr.error("<?php echo e(translate('messages.your_cart_is_empty')); ?>", {
                    CloseButton: true,
                    ProgressBar: true
                });
                }
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(
                    (position) => {
                        ...
                        infoWindow.setContent("<?php echo e(translate('Click_on_the_map_inside_the_red_marked_area_for_the_Lat/Long')); ?>");
                        infoWindow.open(map);
                        ...
                        geocoder.geocode({'latLng': latlng}, function (results, status) {
                            if (status == google.maps.GeocoderStatus.OK) {
                                if (results[1]) {
                                    ...
                                    // build request
                                    const origin1 = {
                                        lat: <?php echo e($restaurant_data['latitude']); ?>,
                                        lng: <?php echo e($restaurant_data['longitude']); ?>
                                    ...
                                    service.getDistanceMatrix(request).then((response) => {
                                        ...
                                        $.get({
                                            ...
                                            success: function (data) {
                                                ...
                                                let with_increased_fee = (delivery_amount * <?php echo e($increased); ?>) / 100;
                                                ...
                                                $('#delivery_fee').siblings('strong').html(delivery_charge + ' (<?php echo e(Helpers::currency_symbol()); ?>)');
        ...
        function handleLocationError(browserHasGeolocation, infoWindow, pos) {
            ...
            infoWindow.setContent(
                browserHasGeolocation ?
                    "Error: <?php echo e(translate('The_Geolocation_service_failed')); ?>." :
                    "Error: <?php echo e(translate('Your_browser_does_not_support_geolocation')); ?>."
            );
            infoWindow.open(map);
        }
                ...
                success: function (data) {
                    if (data.data === 1) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Cart',
                            text: "<?php echo e(translate('messages.product_quantity_updated_in_cart')); ?>"
                        });
                        updateCart();
                        return false;
                    }
        ...
        $(document).on('click', '.delivery-Address-Store', function (event) {
            if(document.getElementById('contact_person_name').value == ''){
                ...
                event.preventDefault();
                    ...
                    toastr.error("<?php echo e(translate('messages.Could_Not_Calculate_the_Delivery_Fee._Click_on_the_map_again_to_calculate_it.')); ?>", {
                    CloseButton: true,
                    ProgressBar: true
                });
                event.preventDefault();
        ...
        $(document).on('click', '.empty-Cart', function (event) {
            if(document.getElementById('cart_food_id').value == '' ){
                ...
                $.post('<?php echo e(route('admin.pos.emptyCart')); ?>', {
                    ...
                    $('#del-add').empty();
                    updateCart();
                    toastr.success('<?php echo e(translate('messages.Cart_Cleared_Successfully')); ?>', {
                        CloseButton: true,
                        ProgressBar: true
                    });
                });
        ...
        $(document).on('change', '.update-Quantity', function (event) {
            ...
            if (valueCurrent >= minValue && maxValue >= valueCurrent) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: "<?php echo e(translate('Cart')); ?>",
                    text: "<?php echo e(translate('quantity_unavailable')); ?>"
                });
            }
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/pos/index.blade.php ENDPATH**/ ?>