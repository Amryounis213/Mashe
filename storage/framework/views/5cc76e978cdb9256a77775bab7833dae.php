                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center gap-3">
                                ...
                                <div class="image-box">
                                    ...
                                    <img class="upload-icon initial-26"   src="<?php echo e(\App\CentralLogics\Helpers::onerror_image_helper(
                                        $product['image'] ?? '',
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-6 col-lg-3" id="halal">
                                    <div class="form-check mb-0 p-4">
                                        <input class="form-check-input" name="is_halal" type="checkbox" value="1" id="flexCheckDefault" <?php echo e($product->is_halal == 1?'checked':''); ?>>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="stock_type" id="stock_type" class="form-control js-select2-custom">
                                            <option  <?php echo e($product->stock_type == 'unlimited' ? 'selected' : ''); ?>  value="unlimited"><?php echo e(translate('messages.Unlimited_Stock')); ?></option>
                                            <option  <?php echo e($product->stock_type == 'limited' ? 'selected' : ''); ?> value="limited"><?php echo e(translate('messages.Limited_Stock')); ?></option>
                                            <option  <?php echo e($product->stock_type == 'daily' ? 'selected' : ''); ?> value="daily"><?php echo e(translate('messages.Daily_Stock')); ?></option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 hide_this" id="">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" value="<?php echo e($product->item_stock); ?>"  placeholder="<?php echo e(translate('messages.Ex:_10')); ?>" class="form-control stock_disable" name="item_stock" min="0" max="999999999" id="item_stock">
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/product/edit.blade.php ENDPATH**/ ?>