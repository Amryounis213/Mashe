            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                ...
                <div>
                    <a class="btn btn--primary" href="<?php echo e(route('admin.dashboard')); ?>">
                        <i class="tio-dashboard-vs ml-xl-2"></i> <?php echo e(translate('messages.dashboard')); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h2 class="card-title h4">
                                <i class="tio-user-outlined"></i> &nbsp; <?php echo e(translate('messages.basic_information')); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel" class="col-sm-3 col-form-label input-label"><?php echo e(translate('messages.full_name')); ?></label>

                                <div class="col-sm-9">
                                    <div class="input-group input-group-sm-down-break">
                                        <input type="text" class="form-control h--45px" name="f_name" id="firstNameLabel"
                                               placeholder="<?php echo e(translate('messages.Ex:_Jhon')); ?> " aria-label="<?php echo e(translate('messages.your_first_name')); ?>"
                                               value="<?php echo e(auth('admin')->user()->f_name); ?>">
                                        <input type="text" class="form-control h--45px" name="l_name" id="lastNameLabel"
                                               placeholder="<?php echo e(translate('messages.Ex:_Doe')); ?> " aria-label="<?php echo e(translate('messages.your_last_name')); ?>"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="tel" class="js-masked-input form-control h--45px" name="phone" id="phoneLabel"
                                           placeholder="<?php echo e(translate('messages.Ex:_+x(xxx)xxx-xx-xx')); ?> " aria-label="+(xxx)xx-xxx-xxxxx"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control h--45px" name="email" id="newEmailLabel"
                                           ...
                                           placeholder="<?php echo e(translate('messages.Ex:_jhone@company.com')); ?> " aria-label="<?php echo e(translate('messages.enter_new_email_address')); ?>">
                                </div>
                            </div>
                ...
                <div id="passwordDiv" class="card mb-3">
                    <div class="card-header">
                        <h4 class="card-title"><i class="tio-lock-outlined"></i>  &nbsp; <?php echo e(translate('messages.change_your_password')); ?></h4>
                    </div>

                    <!-- Body -->
                    <div class="card-body">
                        <!-- Form -->
                        <form id="changePasswordForm" class="js-validate" action="<?php echo e(env('APP_MODE')!='demo'?route('admin.settings-password'):'javascript:'); ?>" method="post"
                              enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>

                        <!-- Form Group -->
                            <div class="row js-form-message form-group">
                                <label for="signupSrPassword" class="col-sm-3 col-form-label input-label"><?php echo e(translate('messages.new_password')); ?>
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <?php else: ?>
                                    <button type="button" class="btn btn--primary call-demo"><?php echo e(translate('messages.save')); ?></button>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/settings.blade.php ENDPATH**/ ?>