    ...
    <div class="content container-fluid">
        <div class="page-header">
            ...
            <span class="page-header-icon">
                ...
                <span><?php echo e(translate($tab)); ?> <?php echo e(translate('Disbursement_Report')); ?></span>
            </h1>
            ...
            <div class="search--button-wrapper">
                ...
                <div class="hs-unfold ml-3">
                    ...
                    <div id="usersExportDropdown"
                        ...
                        <a id="export-excel" class="dropdown-item" href="<?php echo e(route('admin.report.disbursement_report_export', ['type'=>'excel','tab'=>$tab,request()->getQueryString()])); ?>">
                        ...
                        <a id="export-csv" class="dropdown-item" href="<?php echo e(route('admin.report.disbursement_report_export', ['type'=>'excel','tab'=>$tab,request()->getQueryString()])); ?>">
            ...
            <div class="table-responsive">
                <table class="table table-thead-bordered table-align-middle card-table">
                    ...
                    <tr>
                        ...
                        <?php if($tab=='restaurant'): ?>
                        <th><?php echo e(translate('Restaurant_Info')); ?></th>
                        <?php else: ?>
                    ...
                    <?php $__currentLoopData = $disbursements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $disbursement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <?php if($tab=='restaurant'): ?>
                            <td>
                                <a href="<?php echo e(route('admin.restaurant.view', $disbursement->restaurant->id)); ?>" alt="view restaurant"
                                   class="table-rest-info">
                                    <div class="info">
                                            <span class="d-block text-body">
                                                <?php echo e(Str::limit($disbursement->restaurant->name, 20, '...')); ?><br>
                                            </span>
                                    </div>
                                </a>
                            </td>
                            <?php else: ?>
                                <td>
                                    <a href="<?php echo e(route('admin.delivery-man.preview', $disbursement->delivery_man_id)); ?>"
                                       class="table-rest-info">
                                        <div class="info">
                                            <span class="d-block text-body">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex flex-wrap payment-info-modal-info p-xl-4">
                                                        <div class="item">
                                                            ...
                                                            <ul class="item-list">
                                                                <li class="d-flex flex-wrap">
                                                                    ...
                                                                    <span>:</span>
                                                                    <strong><?php echo e($disbursement?->restaurant?->name); ?></strong>
                                                                </li>
                                                                <li class="d-flex flex-wrap">
                                                                    <span class="name"><?php echo e(translate('contact')); ?></span>
                                                                    <span>:</span>
                                                                    <strong><?php echo e($disbursement?->restaurant?->phone); ?></strong>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="item">
                                                            ...
                                                            <ul class="item-list">
                                                                <li class="d-flex flex-wrap">
                                                                    <span class="name"><?php echo e(translate('name')); ?></span>
                                                                    <span>:</span>
                                                                    <strong><?php echo e($disbursement->restaurant->vendor->f_name); ?> <?php echo e($disbursement->restaurant->vendor->l_name); ?></strong>
                                                                </li>
                                                                <li class="d-flex flex-wrap">
                                                                    <span class="name"><?php echo e(translate('email')); ?></span>
                                                                    <span>:</span>
                                                                    <strong><?php echo e($disbursement->restaurant->vendor->email); ?></strong>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="item w-100">
                                                            ...
                                                            <ul class="item-list">
                                                                <li class="d-flex flex-wrap">
                                                                    <span class="name"><?php echo e(translate('payment_method')); ?></span><strong><?php echo e($disbursement?->withdraw_method?->method_name ?? translate('Default_method')); ?></strong>
                                                                </li>
                                                                <li class="d-flex flex-wrap">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/report/disbursement-report.blade.php ENDPATH**/ ?>