        ...
        <div class="page-header">
            <h1 class="page-header-title mb-2 text-capitalize">
                <div class="card-header-icon d-inline-flex mr-2 img">
                    <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/employee.png')); ?>" alt="public">
                </div>
                <span>
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h5 class="card-title">
                                ...
                                <span>
                                    <?php echo e(translate('Genaral_Information')); ?>
                            ...
                            <div class="row">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            <div class="form-group mb-0">
                                                <label class="form-label " for="fname"><?php echo e(translate('messages.first_name')); ?></label>
                                                <input type="text" name="f_name" class="form-control h--45px" id="fname"
                                                       placeholder="<?php echo e(translate('Ex:_John')); ?>" value="<?php echo e(old('f_name')); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group mb-0">
                                                <label class="form-label " for="lname"><?php echo e(translate('messages.last_name')); ?></label>
                                                <input type="text" name="l_name" class="form-control h--45px" id="lname" value="<?php echo e(old('l_name')); ?>" placeholder="<?php echo e(translate('Ex:_Doe')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group mb-0">
                                                <label class="form-label" for="title"><?php echo e(translate('messages.zone')); ?></label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-0">
                                                <label class="form-label " for="role_id"><?php echo e(translate('messages.Role')); ?></label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" name="phone" value="<?php echo e(old('phone')); ?>" class="form-control h--45px" id="phone"
                                                       placeholder="<?php echo e(translate('Ex:_+8801******')); ?>" required>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex flex-column align-items-center gap-3">
                                        <p class="mb-0"><?php echo e(translate('Employee image')); ?></p>
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <span class="card-header-icon">
                                ...
                                <span>
                                <?php echo e(translate('messages.account_info')); ?>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="form-control h--45px" id="email"
                                           placeholder="<?php echo e(translate('Ex:_ex@gmail.com')); ?>" required>
                                </div>
                                <div class="col-md-4">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/employee/add-new.blade.php ENDPATH**/ ?>