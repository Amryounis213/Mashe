...
<html dir="<?php echo e($site_direction); ?>" lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" >
...
<head>
    ...
    <title><?php echo $__env->yieldContent('title','Landing Page | '); ?></title>

    <link rel="stylesheet" href="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/css/bootstrap.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/css/animate.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/css/all.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/css/owl.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/css/main.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(dynamicAsset('public/assets/admin/css/toastr.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(dynamicAsset('public/assets/admin/css/select2.min.css')); ?>">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(dynamicStorage('storage/app/public/business/'. $icon ?? '')); ?>">
...
<body>
    ...
    <header>
        <div class="container">
            <div class="header-wrapper">
                ...
                <div class="logo">
                    <a href="/">
                        <img src="<?php echo e(dynamicStorage('storage/app/public/business/' . $logo)); ?>" alt="">
                    </a>
                </div>
                ...
                <ul class="menu">
                    <li>
                        <a href="<?php echo e(route('home')); ?>" class="<?php echo $__env->yieldContent('home'); ?>">
                    ...
                    <li>
                        <a href="<?php echo e($landing_page_links['web_app_url']); ?>">
                            ...
                            <?php echo e(translate('messages.browse_web')); ?>

                        </a>
                    </li>
                    <?php endif; ?>
                    <li>
                        <a href="<?php echo e(route('about-us')); ?>"  class="<?php echo $__env->yieldContent('about'); ?>">
                            <svg width="25" height="8" viewBox="0 0 25 8" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M25 6.9176L17.1875 5.7514L17.1875 4.8764L25 4.2926L25 3.7088L17.1875 3.125L17.1875 2.25L25 1.0838L25 0.5L14.8438 0.5C14.6366 0.5 14.4379 0.57375 14.2914 0.705025C14.1448 0.836301 14.0625 1.01435 14.0625 1.2L14.0625 3.0228L1.55946 2.3354C1.35875 2.32241 1.15722 2.34688 0.967606 2.40725C0.77799 2.46762 0.604418 2.56259 0.457861 2.68614C0.311302 2.80969 0.194948 2.95915 0.116154 3.12505C0.037361 3.29096 -0.00216116 3.46971 9.1415e-05 3.65L9.13844e-05 4.35C9.13508e-05 5.12 0.70165 5.7108 1.55946 5.6646L14.0625 4.9772L14.0625 6.8C14.0625 6.98565 14.1448 7.1637 14.2914 7.29497C14.4379 7.42625 14.6366 7.5 14.8438 7.5L25 7.5L25 6.9162L25 6.9176Z"
                            ...
                            <?php echo e(translate('messages.about')); ?>

                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('privacy-policy')); ?>"  class="<?php echo $__env->yieldContent('privacy-policy'); ?>" >
                            <svg width="25" height="8" viewBox="0 0 25 8" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M25 6.9176L17.1875 5.7514L17.1875 4.8764L25 4.2926L25 3.7088L17.1875 3.125L17.1875 2.25L25 1.0838L25 0.5L14.8438 0.5C14.6366 0.5 14.4379 0.57375 14.2914 0.705025C14.1448 0.836301 14.0625 1.01435 14.0625 1.2L14.0625 3.0228L1.55946 2.3354C1.35875 2.32241 1.15722 2.34688 0.967606 2.40725C0.77799 2.46762 0.604418 2.56259 0.457861 2.68614C0.311302 2.80969 0.194948 2.95915 0.116154 3.12505C0.037361 3.29096 -0.00216116 3.46971 9.1415e-05 3.65L9.13844e-05 4.35C9.13508e-05 5.12 0.70165 5.7108 1.55946 5.6646L14.0625 4.9772L14.0625 6.8C14.0625 6.98565 14.1448 7.1637 14.2914 7.29497C14.4379 7.42625 14.6366 7.5 14.8438 7.5L25 7.5L25 6.9162L25 6.9176Z"
                    ...
                    <li>
                        <a href="<?php echo e(route('contact-us')); ?>" class="<?php echo $__env->yieldContent('contact'); ?>">
                            <svg width="25" height="8" viewBox="0 0 25 8" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M25 6.9176L17.1875 5.7514L17.1875 4.8764L25 4.2926L25 3.7088L17.1875 3.125L17.1875 2.25L25 1.0838L25 0.5L14.8438 0.5C14.6366 0.5 14.4379 0.57375 14.2914 0.705025C14.1448 0.836301 14.0625 1.01435 14.0625 1.2L14.0625 3.0228L1.55946 2.3354C1.35875 2.32241 1.15722 2.34688 0.967606 2.40725C0.77799 2.46762 0.604418 2.56259 0.457861 2.68614C0.311302 2.80969 0.194948 2.95915 0.116154 3.12505C0.037361 3.29096 -0.00216116 3.46971 9.1415e-05 3.65L9.13844e-05 4.35C9.13508e-05 5.12 0.70165 5.7108 1.55946 5.6646L14.0625 4.9772L14.0625 6.8C14.0625 6.98565 14.1448 7.1637 14.2914 7.29497C14.4379 7.42625 14.6366 7.5 14.8438 7.5L25 7.5L25 6.9162L25 6.9176Z"
                ...
                <?php if((isset($toggle_dm_registration)  && $toggle_dm_registration )|| (isset($toggle_restaurant_registration) && $toggle_restaurant_registration)): ?>
                <div class="position-relative">
                    <a class="dropdown--btn btn-base" href="javascript:void(0)">
                        <span><?php echo e(translate('Join us')); ?></span>
                    ...
                    <ul class="dropdown-list">
                        ...
                        <li>
                            <a href="<?php echo e(route('restaurant.create')); ?>"> <?php echo e(translate('messages.join_as_restaurant')); ?></a>
                        </li>
                        <?php endif; ?>
                        <?php if($toggle_dm_registration): ?>
                        <li>
                            <a href="<?php echo e(route('deliveryman.create')); ?>"><?php echo e(translate('messages.join_as_deliveryman')); ?></a>
                        </li>
                        <?php endif; ?>
                    </ul>
                </div>
    ...
    <?php echo $__env->yieldContent('content'); ?>
        ...
        <footer class="footer-bg">
            <div class="newsletter-section">
                <div class="container">
                    ...
                    <?php if(isset($landing_data['news_letter_title']) ): ?>
                        <div class="newsletter-content position-relative">
                            <h3 class="title">
                                <?php echo e($landing_data['news_letter_title'] ?? translate('messages.news_letter_signup')); ?>

                                </h3>
                            <div class="text">
                                <?php echo e($landing_data['news_letter_sub_title'] ??  translate('messages.news_letter_signup_text')); ?>

                            </div>
                            <form method="post" action="<?php echo e(route('newsletter.subscribe')); ?>">
                               <?php echo csrf_field(); ?>
                                <div class="input--grp">
                                    <input type="email" name="email" class="form-control" required placeholder="<?php echo e(translate('Enter your email address')); ?>" value="<?php echo e(old('email')); ?>">
                ...
                <div class="container">
                    <div class="footer-wrapper ps-xl-5">
                        <div class="footer-widget">
                            ...
                            <div class="txt">
                                <?php echo e(isset($landing_data['footer_data']) ? $landing_data['footer_data'] : ''); ?>
                            ...
                            <ul class="social-icon">
                                ...
                                <?php if(isset($social_media)): ?>
                                    ...
                                    <li>
                                        <a class="social-btn text-white" target="_blank" href="<?php echo e($social->link); ?>">
                                            <i class="fab fa-<?php echo e($social->name); ?> fa-2x" aria-hidden="true"></i>
                                        </a>
                                    </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            ...
                            <div class="app-btn-grp">
                                ...
                                <a href="<?php echo e($landing_page_links['app_url_android']); ?>">
                                    <img src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/img/google.svg')); ?>" alt="">
                                </a>
                                <?php endif; ?>
                            <?php if($landing_page_links['app_url_ios_status']): ?>
                                <a href="<?php echo e($landing_page_links['app_url_ios']); ?>">
                                    <img src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/img/apple.svg')); ?>" alt="">
                                </a>
                            </div>
                            <?php endif; ?>
                            <?php endif; ?>
                        ...
                        <div class="footer-widget widget-links">
                            <h5 class="subtitle mt-2 text-white"><?php echo e(translate('messages.quick_links')); ?></h5>
                            <ul>
                                <li>
                                ...
                                <li>
                                    <a
                                        href="<?php echo e(route('shipping-policy')); ?>"><?php echo e(translate('messages.shipping_policy')); ?></a>
                                </li>
                                <?php endif; ?>
                                <?php if(isset($landing_data['refund_policy_status']) && $landing_data['refund_policy_status']  == 1): ?>
                                <li>
                                    <a
                                        href="<?php echo e(route('refund-policy')); ?>"><?php echo e(translate('messages.refund_policy')); ?></a>
                                </li>
                                <?php endif; ?>
                                <?php if(isset($landing_data['cancellation_policy_status']) && $landing_data['cancellation_policy_status']  == 1): ?>
                                <li>
                                    <a
                                        href="<?php echo e(route('cancellation-policy')); ?>"><?php echo e(translate('messages.cancellation_policy')); ?></a>
                                </li>
                                <?php endif; ?>
                        ...
                        <div class="footer-widget widget-links">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <a target="blank" href="http://maps.google.com/?q=<?php echo e($address); ?>">
                                ...
                                <li>
                                    ...
                                    <a href="mailto:<?php echo e($email_address); ?>">
                    ...
                    <div class="copyright text-center mt-3">
                        ...
                        <?php echo e(translate('By')); ?> <?php echo e(\App\CentralLogics\Helpers::get_settings('business_name')); ?>
        ...
        <script src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/js/jquery-3.6.0.min.js')); ?>"></script>
        <script src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/js/bootstrap.min.js')); ?>"></script>
        <script src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/js/viewport.jquery.js')); ?>"></script>
        <script src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/js/wow.min.js')); ?>"></script>
        <script src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/js/owl.min.js')); ?>"></script>
        <script src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/js/main.js')); ?>"></script>
        <script src="<?php echo e(dynamicAsset('/public/assets/admin/js/toastr.js')); ?>"></script>
        <script src="<?php echo e(dynamicAsset('/public/assets/admin/js/select2.min.js')); ?>"></script>
...
<?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/layouts/landing/app.blade.php ENDPATH**/ ?>