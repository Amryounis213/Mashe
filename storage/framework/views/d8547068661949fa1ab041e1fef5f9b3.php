<?php $__env->startSection('title', translate('messages.add_new_market')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid initial-57">
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-shop-outlined"></i>
                        <?php echo e(translate('messages.add_new_market')); ?></h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        ...
        <form action="<?php echo e(route('admin.market.store')); ?>" method="post" enctype="multipart/form-data"
                    ...
                    <div class="card shadow--card-2">
                        <div class="card-body">
                            ...
                            <div class="lang_form" id="default-form">
                                ...
                                <label class="input-label" for="exampleFormControlInput1"><?php echo e(translate('messages.market_name')); ?> (<?php echo e(translate('messages.default')); ?>)</label>
                                    <input type="text" name="name[]" class="form-control"  placeholder="<?php echo e(translate('messages.Ex:_ABC_Company')); ?> " maxlength="191"   >
                                </div>
                                <input type="hidden" name="lang[]" value="default">

                                <div>
                                    <label class="input-label" for="address"><?php echo e(translate('messages.market_address')); ?> (<?php echo e(translate('messages.default')); ?>)</label>
                                ...
                                <div class="d-none lang_form" id="<?php echo e($lang); ?>-form">
                                    ...
                                    <div class="form-group" >
                                        <label class="input-label" for="exampleFormControlInput1"><?php echo e(translate('messages.market_name')); ?> (<?php echo e(strtoupper($lang)); ?>)</label>
                                        <input type="text" name="name[]" class="form-control"  placeholder="<?php echo e(translate('messages.Ex:_ABC_Company')); ?> " maxlength="191"  >
                                    </div>
                                    <input type="hidden" name="lang[]" value="<?php echo e($lang); ?>">

                                    <div>
                                        <label class="input-label" for="address"><?php echo e(translate('messages.market_address')); ?> (<?php echo e(strtoupper($lang)); ?>)</label>
                                        <textarea id="address" name="address[]" class="form-control h-70px" placeholder="<?php echo e(translate('messages.Ex:_House#94,_Road#8,_Abc_City')); ?> "  ></textarea>
                                    </div>
                    ...
                    <div class="card shadow--card-2">
                        <div class="card-header">
                            <h5 class="card-title">
                                ...
                                <span><?php echo e(translate('Market_Logo_&_Covers')); ?></span>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="d-flex flex-wrap flex-sm-nowrap justify-content-around __gap-12px">
                                ...
                                <div class="d-flex flex-column align-items-center gap-3">
                                    <p class="mb-0"><?php echo e(translate('logo')); ?></p>
                                ...
                                <div>
                                    <div class="d-flex flex-column align-items-center gap-3 mw-100">
                                        <p class="mb-0"><?php echo e(translate('Market_Cover')); ?></p>
                ...
                <div class="col-lg-12">
                    <div class="card shadow--card-2">
                        <div class="card-header">
                            <h5 class="card-title">
                                <span class="card-header-icon mr-1"><i class="tio-dashboard"></i></span>
                                <span><?php echo e(translate('Market_Info')); ?></span>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-2">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="choice_zones"><?php echo e(translate('messages.zone')); ?>
                                                ...
                                                class="input-label-secondary"><img
                                                    ...
                                                    alt="<?php echo e(translate('messages.market_lat_lng_warning')); ?>"></span>
                                                </label>
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="latitude"><?php echo e(translate('messages.latitude')); ?><span data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('messages.This_point_marks_the_latitude_of_the_market’s_location_on_the_map.')); ?>"
                                                class="input-label-secondary"><img
                                                    src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                    alt="<?php echo e(translate('messages.market_lat_lng_warning')); ?>"></span></label>
                                    ...
                                    <div class="form-group mb-md-0">
                                        <label class="input-label" for="longitude"><?php echo e(translate('messages.longitude')); ?>
                                                ...
                                                <span data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('messages.This_point_marks_the_longitude_of_the_market’s_location_on_the_map')); ?>"
                                                class="input-label-secondary"><img
                                                    src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                    alt="<?php echo e(translate('messages.market_lat_lng_warning')); ?>"></span>
                                                </label>
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script>
        ...
        $(function() {
            $("#coba").spartanMultiImagePicker({
                ...
                let infoWindow = new google.maps.InfoWindow({
                    content: "<?php echo e(translate('Click_the_map_inside_the_red_marked_area_to_get_Lat/Lng!!!')); ?>",
                    position: myLatlng,
                });
                    ...
                    if (navigator.geolocation) {
                        navigator.geolocation.getCurrentPosition(
                            (position) => {
                                ...
                                infoWindow.setContent("<?php echo e(translate('Select_Zone_From_The_Dropdown')); ?>");
                                infoWindow.open(map);
                ...
                function handleLocationError(browserHasGeolocation, infoWindow, pos) {
                    ...
                    infoWindow.setContent(
                        ...
                        "<?php echo e(translate('Select_Zone_From_The_Dropdown.')); ?>" :
                        "<?php echo e(translate('Error:_Your_browser_doesnot_support_geolocation.')); ?>"
                    );
                    infoWindow.open(map);
                }
        ...
        $('#reset_btn').click(function(){
            ...
            $('#coverImageViewer').attr('src', "<?php echo e(dynamicAsset('public/assets/admin/img/upload-img.png')); ?>");
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/market/index.blade.php ENDPATH**/ ?>