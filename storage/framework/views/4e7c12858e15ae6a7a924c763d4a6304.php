                                        ...
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                <span class="line--limit-1">
                                                    <?php echo e(translate('Tips_for_Deliveryman')); ?>

                                                </span>
                                                <span class="form-label-secondary text-danger d-flex"
                                                    data-toggle="tooltip" data-placement="right"
                                                    data-original-title="<?php echo e(translate('Customers_can_give_tips_to_deliverymen_during_checkout_from_the_Customer_App_&_Website._Admin_will_not_earn_any_commission_from_it.')); ?>"><img
                                            ...
                                            data-title-on="<?php echo e(translate('Want_to_enable_the')); ?> <strong><?php echo e(translate('Delivery Man Tips')); ?></strong> <?php echo e(translate('feature')); ?> ?"
                                            data-title-off="<?php echo e(translate('Want_to_disable_the')); ?> <strong><?php echo e(translate('Delivery Man Tips')); ?></strong> <?php echo e(translate('feature')); ?> ?"
                                            data-text-on="<p><?php echo e(translate('If_enabled,_Customers_can_give_tips_to_a_deliveryman_during_checkout')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('If_disabled,_the_Tips_for_Deliveryman_feature_will_be_hidden_from_the_Customer_App_and_Website')); ?></p>"
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex"
                                                    data-toggle="tooltip" data-placement="right"
                                                    data-original-title="<?php echo e(translate('With_this_feature,_Deliverymen_can_see_their_earnings_on_a_specific_order_while_accepting_it.')); ?>"><img
                                                        src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>"
                                            ...
                                            data-title-on="<?php echo e(translate('Want_to_enable_the')); ?> <strong><?php echo e(translate('Show Earnings in Apps')); ?></strong> ?"
                                            data-title-off="<?php echo e(translate('Want_to_disable_the')); ?> <strong><?php echo e(translate('Show Earnings in Apps')); ?></strong> ?"
                                            data-text-on="<p><?php echo e(translate('If_enabled,_Deliverymen_can_see_their_earning_per_order_request_from_the_Order_Details_page_in_the_Deliveryman_App.')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('If_disabled,_the_feature_will_be_hidden_from_the_Deliveryman_App')); ?></p>"
                                            class="toggle-switch-input dynamic-checkbox-toggle"
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <label
                                            ...
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                ...
                                                <span class="form-label-secondary text-danger d-flex"
                                                    data-toggle="tooltip" data-placement="right"
                                                    data-original-title="<?php echo e(translate('With_this_feature,_deliverymen_can_register_themselves_from_the_Customer_App,_Website,_Deliveryman_App_or_Admin_Landing_Page._The_admin_will_receive_an_email_notification_and_can_accept_or_reject_the_request')); ?>"><img
                                                        src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>"
                                            ...
                                            data-title-on="<?php echo e(translate('Want_to_enable_the')); ?> <strong><?php echo e(translate('DeliveryMan_Self_Registration')); ?></strong> ?"
                                            data-title-off="<?php echo e(translate('Want_to_disable_the')); ?> <strong><?php echo e(translate('DeliveryMan_Self_Registration')); ?></strong> ?"
                                            data-text-on="<p><?php echo e(translate('If_enabled,_Customers_can_register_as_Deliverymen_from_the_Customer_App,_Website_or_Deliveryman_App_or_Admin_Landing_Page')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('If_disabled,_this_feature_will_be_hidden_from_the_Customer_App,_Website,_Deliveryman_App_or_Admin_Landing_Page.')); ?></p>"
                                            class="toggle-switch-input dynamic-checkbox-toggle"
                                            value="1"
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="input-label d-flex text-capitalize"
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="line--limit-1 flex-grow"><?php echo e(translate('Maximum Assigned Order Limit')); ?> </span>
                                            </div>
                                            <span class="form-label-secondary"
                                            data-toggle="tooltip" data-placement="right"
                                            data-original-title="<?php echo e(translate('Set_the_maximum_order_limit_a_Deliveryman_can_take_at_a_time')); ?>"><img
                                                src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="input-label text-capitalize d-flex alig-items-center"><span
                                                class="line--limit-1"><?php echo e(translate('Can_A_Deliveryman_Cancel_Order')); ?></span>
                                            <span class="form-label-secondary"
                                            data-toggle="tooltip" data-placement="right"
                                            data-original-title="<?php echo e(translate('Admin_can_enable/disable_Deliveryman’s_order_cancellation_option_in_the_respective_app')); ?>"><img
                                                src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                alt="<?php echo e(translate('messages.dm_cancel_order_hint')); ?>"></span>
                                            </label>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group  mb-0 ">
                                        ...
                                        <label
                                            ...
                                            data-text-on="<p><?php echo e(translate('If_enabled,_delivery_men_have_to_provide_collected_cash_by_them_self')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('If_disabled,_delivery_men_do_not_have_to_provide_collected_cash_by_them_self')); ?></p>"
                                            class="toggle-switch-input dynamic-checkbox-toggle"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group  mb-0">
                                        ...
                                        <label
                                            ...
                                            <?php echo e($dm_picture_upload_status?->value == 1 ? 'checked' : ''); ?>>
                                        <span class="toggle-switch-label text">
                                            <span class="toggle-switch-indicator"></span>
                                        </span>
                                        </label>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/business-settings/deliveryman-index.blade.php ENDPATH**/ ?>