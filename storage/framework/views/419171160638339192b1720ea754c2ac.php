<?php $__env->startSection('title',translate('messages.add_new_food')); ?>
            ...
            <div class="row g-2">
                                ...
                                <label>
                                    <center id="image-viewer-section" class="my-auto">
                                        <img class="initial-52 object--cover border--dashed" id="viewer"
                                            src="<?php echo e(dynamicAsset('/public/assets/admin/img/upload.png')); ?>"
                                            alt="banner image" />
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="exampleFormControlSelect1"><?php echo e(translate('messages.category')); ?><span
                                                ...
                                                data-url="<?php echo e(url('/')); ?>/restaurant-panel/food/get-categories?parent_id=" data-id="sub-categories">
                                            <option value="" selected disabled>---<?php echo e(translate('messages.Select Category')); ?>---</option>
                                        ...
                                        <label class="input-label"
                                            for="exampleFormControlSelect1"><?php echo e(translate('messages.sub_category')); ?><span
                                                ...
                                                data-original-title="<?php echo e(translate('messages.category_required_warning')); ?>"><img
                                                    ...
                                                    data-url="<?php echo e(url('/')); ?>/restaurant-panel/food/get-categories?parent_id=" data-id="sub-sub-categories">
                                                        <option value="" selected disabled>---<?php echo e(translate('messages.Select Sub Category')); ?>---</option>
                                            </select>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select required name="veg" id="veg"
                                            ...
                                            <option value="" selected disabled>
                                                <?php echo e(translate('Select Preferences')); ?></option>
                ...
                <div class="col-lg-6">
                    <div class="card shadow--card-2 border-0">
                        ...
                        <div class="card-body">
                            <label class="input-label"
                                for="exampleFormControlSelect1"><?php echo e(translate('Select Add-on')); ?><span
                                    class="input-label-secondary" data-toggle="tooltip"
                                    data-placement="right"
                        ...
                        <div class="card-body">
                            <div class="row g-2">
                                <div class="col-md-3">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(translate('messages.Unit_Price')); ?> <?php echo e(\App\CentralLogics\Helpers::currency_symbol()); ?></label>
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script src="<?php echo e(dynamicAsset('public/assets/admin')); ?>/js/view-pages/vendor/product-index.js"></script>
<script>
    "use strict";
...
<?php echo $__env->make('layouts.vendor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/vendor-views/product/index.blade.php ENDPATH**/ ?>