            ...
            <div class="row gx-2">
                    ...
                    <div class="card mb-3">
                        <div class="card-header card-header-shadow">
                            <h5 class="card-title d-flex align-items-center">
                                <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/ic_round-campaign.png')); ?>" alt="" class="card-header-icon align-self-center mr-1">
                                <span>
                                    <?php echo e(translate('Customer_Setup')); ?>

                                </span>
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('messages.If_enabled,_customers_can_have_virtual_wallets_in_their_accounts._They_can_also_earn_(via_referral,_refund,_or_loyalty_points)_and_buy_with_the_wallet’s_amount')); ?>"><img src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.show_hide_food_menu')); ?>"></span>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border  rounded px-4 form-control">
                                            <span class="pr-2"><?php echo e(translate('Customer_Verification')); ?>

                                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_you_activate_this_feature,_customers_need_to_verify_their_account_information_via_OTP_during_the_signup_process')); ?>">
                                                    <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.show_hide_food_menu')); ?>">
                                                </span>
                                            </span>
                                            <input type="checkbox"
                                            data-id="customer_verification_status"
                                            data-type="toggle"
                                            data-image-on="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/customer-verification-on.png')); ?>"
                                            data-image-off="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/customer-verification-off.png')); ?>"
                                            data-title-on="<?php echo e(translate('Want_to_enable_the')); ?> <strong><?php echo e(translate('Customer_Verification')); ?></strong> ?"
                                            data-title-off="<?php echo e(translate('Want_to_disable_the')); ?> <strong><?php echo e(translate('Customer_Verification')); ?></strong> ?"
                                            data-text-on="<p><?php echo e(translate('If_enabled,_Customers_must_verify_their_account_via_OTP.')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('If_disabled,_Customers_don’t_need_to_verify_their_account_via_OTP.')); ?></p>"
                                            class="toggle-switch-input dynamic-checkbox-toggle"

                                            name="customer_verification"
                                            id="customer_verification_status" value="1"  <?php echo e(isset($data['customer_verification']) && $data['customer_verification'] == 1 ? 'checked' : ''); ?>>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border  rounded px-4 form-control">
                                            <span class="pr-2"><?php echo e(translate('Customer Can Earn & Buy From Wallet')); ?>

                                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_enabled,_customers_can_earn_and_buy_from_their_wallets.')); ?>">
                                                    <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.show_hide_food_menu')); ?>">
                                                </span>
                                            </span>
                                            <input type="checkbox"
                                            ...
                                            data-type="toggle"
                                            data-image-on="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/wallet-on.png')); ?>"
                                            data-image-off="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/wallet-off.png')); ?>"
                                            data-title-on="<?php echo e(translate('Want_to_enable_the')); ?> <strong><?php echo e(translate('Wallet')); ?></strong> <?php echo e(translate('feature')); ?>"
                                            data-title-off="<?php echo e(translate('Want_to_disable_the')); ?> <strong><?php echo e(translate('Wallet')); ?></strong> <?php echo e(translate('feature')); ?>"
                                            data-text-on="<p><?php echo e(translate('If_enabled,_Customers_can_see_&_use_the_Wallet_option_from_their_profile_in_the_Customer_App_&_Website.')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('If_disabled,_the_Wallet_feature_will_be_hidden_from_the_Customer_App_&_Website')); ?></p>"
                                            class="status toggle-switch-input dynamic-checkbox-toggle"


                                            name="customer_wallet"
                                            id="wallet_status" value="1" <?php echo e(isset($data['wallet_status']) && $data['wallet_status'] == 1 ? 'checked' : ''); ?>>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border  rounded px-4 form-control
                                        <?php echo e(isset($data['wallet_status']) && $data['wallet_status'] == 1 ? '' : 'text-muted'); ?>

                                        ">
                                            <span class="pr-2"><?php echo e(translate('messages.refund_to_wallet')); ?><span
                                                    class="input-label-secondary"
                                                    data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('messages.If_enabled,_Customers_will_automatically_receive_the_refunded_amount_in_their_wallets._But_if_it’s_disabled,_the_Admin_will_handle_the_Refund_Request_in_his_convenient_transaction_channel.')); ?>"><img
                                            ...
                                            data-type="toggle"
                                            data-image-on="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/refund-on.png')); ?>"
                                            data-image-off="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/refund-off.png')); ?>"
                                            data-title-on="<?php echo e(translate('Want_to_enable_the')); ?> <strong><?php echo e(translate('Refund to Wallet')); ?></strong> <?php echo e(translate('feature')); ?>"
                                            data-title-off="<?php echo e(translate('Want_to_disable_the')); ?> <strong><?php echo e(translate('Refund to Wallet')); ?></strong> <?php echo e(translate('feature')); ?>"
                                            data-text-on="<p><?php echo e(translate('If_enabled,_Customers_will_automatically_receive_the_refunded_amount_in_their_wallets.')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('If_disabled,_the_Admin_will_handle_the_Refund_Request_in_his_convenient_transaction_channel_other_than_the_wallet.')); ?></p>"
                                            class="status toggle-switch-input dynamic-checkbox-toggle"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-4 form-control <?php echo e(isset($data['wallet_status']) && $data['wallet_status'] == 1 ? '' : 'text-muted'); ?>">
                                            <span class="pr-2"><?php echo e(translate('customer_can_add_fund_to_wallet')); ?>

                                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('messages.With_this_feature,_customers_can_add_fund_to_wallet_if_the_payment_module_is_available.')); ?>">
                                              <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.add_fund_status')); ?>">
                                                </span>
                                            </span>
                                            <input type="checkbox"
                                            ...
                                            id="add_fund_status" value="1"<?php echo e(isset($data['add_fund_status']) && $data['add_fund_status'] == 1 ? 'checked' : ''); ?>>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <span class="pr-2"><?php echo e(translate('Customer_Can_Earn_Loyalty_Point')); ?>

                                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_enabled,_customers_will_earn_a_certain_amount_of_points_after_each_purchase.')); ?>">
                                                    <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.show_hide_food_menu')); ?>">
                                                </span>
                                            </span>
                                            <input type="checkbox"
                                            ...
                                            data-type="toggle"
                                            data-image-on="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/loyalty-on.png')); ?>"
                                            data-image-off="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/loyalty-off.png')); ?>"
                                            data-title-on="<?php echo e(translate('Want_to_enable_the')); ?> <strong><?php echo e(translate('Loyalty_Point')); ?></strong> ?"
                                            data-title-off="<?php echo e(translate('Want_to_disable_the')); ?> <strong><?php echo e(translate('Loyalty_Point')); ?></strong> ?"
                                            data-text-on="<p><?php echo e(translate('Customer_will_see_loyalty_point_option_in_his_profile_settings_&_can_earn_&_convert_this_point_to_wallet_money')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('Customer_will_no_see_loyalty_point_option_from_his_profile_settings')); ?></p>"
                                            class="toggle-switch-input dynamic-checkbox-toggle"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label
                                            class="toggle-switch toggle-switch-sm d-flex justify-content-between border  rounded px-4 form-control <?php echo e(isset($data['wallet_status']) && $data['wallet_status'] == 1 ? '' : 'text-muted'); ?>">
                                            <span
                                                class="pr-2"><?php echo e(translate('Customer_referrer_earning')); ?></span>
                                            <input type="checkbox"
                                            data-id="ref_earning_status"
                                            data-type="toggle"
                                            data-image-on="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/referral-on.png')); ?>"
                                            data-image-off="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/referral-off.png')); ?>"
                                            data-title-on="<?php echo e(translate('Want_to_enable_the')); ?> <strong><?php echo e(translate('Referral_Earning')); ?></strong> ?"
                                            data-title-off="<?php echo e(translate('Want_to_disable_the')); ?> <strong><?php echo e(translate('Referral_Earning')); ?></strong> ?"
                                            data-text-on="<p><?php echo e(translate('If_enabled,_Customers_can_earn_points_by_referring_others_to_sign_up_&_first_purchase_successfully_from_your_business.')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('If_disabled,_the_referral-earning_feature_will_be_hidden_from_the_Customer_App_&_Website.')); ?></p>"
                                            class="toggle-switch-input dynamic-checkbox-toggle"
                ...
                <div class="col-12">
                    ...
                    <div class="card mb-3">
                        <div class="card-header card-header-shadow">
                            <h5 class="card-title">
                                <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/loyalty.png')); ?>" alt="" class="card-header-icon align-self-center mr-1">
                                <span>
                                    <?php echo e(translate('Customer_Loyalty_Point_Settings')); ?>

                                </span>
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('With_this_feature,_customers_can_earn_loyalty_points_after_purchasing_food_from_this_system.')); ?>">
                                    <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.show_hide_food_menu')); ?>">
                                </span>
                            </h5>
                        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card mt-2">
                        <div class="card-header card-header-shadow">
                            <h5 class="card-title">
                                <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/loyalty.png')); ?>" alt=""
                                ...
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right"
                                    ...
                                    <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>"
                                    ...
                                    <div class="align-self-center  col-4">
                                        <div class="text-left">
                                            <h4 class="align-items-center">
                                                <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/referral.png')); ?>"
                                ...
                                <div class="row g-3 align-items-end">
                                    <div class="align-self-center col-4 text-center">
                                        <div class="text-left">
                                            ...
                                            <h4 class="align-items-center">
                                                <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/Who_Use_the_code.png')); ?>"
                                                    alt="" class="card-header-icon align-self-center mr-1">
                                                <span>
                                                    ...
                                                    <div class="form-group mb-0">
                                                        <label
                                                            ...
                                                            type="checkbox" data-id="new_customer_discount_status"
                                                                data-type="toggle"
                                                                data-image-on="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/basic_campaign_on.png')); ?>"
                                                                data-image-off="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/basic_campaign_off.png')); ?>"
                                                                ...
                                                                data-text-off="<p><?php echo e(translate('If_you_disable_this,_Customers_won’t_get_any_discount_on_first_order.')); ?></p>"
                                                                class="status toggle-switch-input dynamic-checkbox-toggle "
                                                    ...
                                                    <div class="col-8 mt-3">
                                                        <div class="form-group mb-0">
                                                            ...
                                                            <?php echo e(isset($data['wallet_status']) && $data['wallet_status'] == 1 && data_get($data, 'new_customer_discount_status') == 1 ? 'required' : 'readonly'); ?>
                                                                ...
                                                                value="<?php echo e(data_get($data, 'new_customer_discount_amount_validity') ?? '1'); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-4 mt-3">
                                                        <div class="form-group  mb-0">
                ...
                <div class="mb-4 mt-4 col-12 ">
                    <div class="btn--container justify-content-end">
                        <button type="reset" id="reset_btn" class="btn btn--reset location-reload"><?php echo e(translate('reset')); ?></button>
                        <button type="submit" id="submit" class="btn btn--primary"><?php echo e(translate('Save Information')); ?></button>
                    </div>
                </div>
            </div>
        </form>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/business-settings/customer-index.blade.php ENDPATH**/ ?>