                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            <a class="btn btn-sm export-btn btn-outline-primary btn--primary font--sm" href="<?php echo e(route('admin.restaurant.categories' , $dm->id)); ?>">
                                                <i class="tio-invisible"></i> <?php echo e(translate('messages.show_menus')); ?>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/vendor/list.blade.php ENDPATH**/ ?>