                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-1 lang_form" id="default-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="title[]" id="default_title" class="form-control" placeholder="<?php echo e(translate('messages.new_campaign')); ?>"  >
                                    </div>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="restaurant_id" id="restaurant_id" class="js-data-example-ajax form-control get-restaurant" data-url="<?php echo e(url('/')); ?>/admin/restaurant/get-addons?data[]=0&restaurant_id=" data-id="add_on"  title="Select Restaurant" required>
                                        <option selected value=""><?php echo e(translate('select_restaurant')); ?></option>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="category_id" id="category_id" class="form-control js-select2-custom get-request"
                                                data-url="<?php echo e(url('/')); ?>/admin/food/get-categories?parent_id=" data-id="sub-categories">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlSelect1"><?php echo e(translate('messages.sub_category')); ?><span
                                                class="input-label-secondary" title="<?php echo e(translate('messages.Make_sure_you_have_selected_a_category_first_!')); ?>"><img src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.Make_sure_you_have_selected_a_category_first_!')); ?>"></span></label>
                                        <select name="sub_category_id" id="sub-categories"
                                                class="form-control js-select2-custom get-request"
                                                data-url="<?php echo e(url('/')); ?>/admin/food/get-categories?parent_id=" data-id="sub-sub-categories">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="veg" id="item_type" class="form-control js-select2-custom">
                                            <option value="0" selected><?php echo e(translate('messages.non_veg')); ?></option>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlSelect1"><?php echo e(translate('messages.addon')); ?><span
                                                class="input-label-secondary" title="<?php echo e(translate('messages.Make_sure_you_have_selected_a_restaurant_first_!')); ?>"><img src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.Make_sure_you_have_selected_a_restaurant_first_!')); ?>"></span></label>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" min=".01" max="999999999999.99" step="0.01" value="1" name="price" class="form-control"
                                                placeholder="<?php echo e(translate('messages.Ex_:_100')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" min="0" max="100000" value="0" name="discount" class="form-control"
                                                placeholder="<?php echo e(translate('messages.Ex_:_100')); ?>" >
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group mb-0">
            ...
            $.post({
                ...
                success: function (data) {
                    if (data.errors) {
                        ...
                        toastr.success('<?php echo e(translate('Campaign_uploaded_successfully!')); ?>', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setTimeout(function () {
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/campaign/item/index.blade.php ENDPATH**/ ?>