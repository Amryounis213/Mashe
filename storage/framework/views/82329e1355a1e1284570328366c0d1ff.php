                ...
                <div class="card h-100">
                    <div class="card-header">
                        <h5 class="card-title m-0 d-flex align-items-center">
                            ...
                            <span class="ml-1"><?php echo e(translate('messages.Restaurant_Model')); ?> : <?php echo e(translate($restaurant->restaurant_model ?? 'None')); ?></span>
                        </h5>
                    </div>
                    <div class="card-body d-flex flex-column justify-content-center">
                        <div class="resturant--info-address">
                            ...
                            <ul class="address-info address-info-2 list-unstyled list-unstyled-py-3 text-dark">
                                ...
                                <?php if(isset($restaurant->restaurant_sub) ): ?>
                                <li>
                                    <span class="pl-1">
                                        <?php echo e(translate('messages.Package_Name')); ?> :
                                        <?php echo e($restaurant->restaurant_sub->package->package_name); ?>
                                ...
                                <li>
                                    <span class="pl-1">
                                        ...
                                        <?php echo e(\App\CentralLogics\Helpers::format_currency($restaurant->restaurant_sub->package->price)); ?>
                                ...
                                <li>
                                    <span class="pl-1">
                                        ...
                                        <?php echo e($restaurant->restaurant_sub->expiry_date->format('d M Y')); ?>

                                    </span>
                                </li>
                                <li>
                                    <?php if($restaurant->restaurant_sub->status == 1): ?>
                                ...
                                <?php elseif(!isset($restaurant->restaurant_sub) && $restaurant->restaurant_model ==
                                'unsubscribed' ): ?>
                                <li>
                                    <span class="pl-1">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/vendor/view/index.blade.php ENDPATH**/ ?>