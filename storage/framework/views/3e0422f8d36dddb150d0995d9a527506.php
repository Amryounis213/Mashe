            ...
            <div class="navbar-vertical-content bg--title" id="navbar-vertical-content">
                ...
                <!-- End Restaurant -->
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('report')): ?>
                        ...
                        <li class="navbar-vertical-aside-has-menu   <?php echo e(Request::is('admin/report/disbursement-report/restaurant') || Request::is('admin/report/disbursement-report/delivery_man')  ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/report/disbursement-report/restaurant') ? 'active' : ''); ?>">
                                    <a class="nav-link " href="<?php echo e(route('admin.report.disbursement_report',  ['tab' => 'restaurant'])); ?>"
                                       title="<?php echo e(translate('messages.restaurants')); ?>">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate"><?php echo e(translate('messages.restaurants')); ?></span>
                                    </a>
                                </li>
                                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/report/disbursement-report/delivery_man') ? 'active' : ''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.report.disbursement_report',  ['tab' => 'delivery_man'])); ?>"
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\mashy\resources\views/layouts/admin/partials/_sidebar.blade.php ENDPATH**/ ?>