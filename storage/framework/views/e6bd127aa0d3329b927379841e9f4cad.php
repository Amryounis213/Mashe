<?php $__env->startSection('title', translate('messages.Denied_Deliveryman_List')); ?>
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <h1 class="page-header-title text-capitalize">
                        ...
                        <span>
                            <?php echo e(translate('messages.Denied_Deliveryman_List')); ?>
            ...
            <ul class="nav nav-tabs page-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active"
                        href="<?php echo e(route('admin.delivery-man.denied')); ?>"><?php echo e(translate('messages.denied_deliveryman')); ?></a>
                </li>
            </ul>
            <!-- End Nav -->
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <div>
                                                    <strong
                                                        class="text-info text-capitalize"><?php echo e(translate('messages.denied')); ?></strong>
                                                </div>
                                            <?php endif; ?>
                                        </td>
                                        <td>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/delivery-man/denied.blade.php ENDPATH**/ ?>