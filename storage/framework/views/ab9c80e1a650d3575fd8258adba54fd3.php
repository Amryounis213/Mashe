                ...
                <div class="card">
                    <div class="card-header border-0">
                        <div class="input-group input---group">
                            ...
                            <input type="search" class="form-control border-inline-start-0 pl-1" id="serach" placeholder="<?php echo e(translate('messages.search')); ?>" aria-label="Username" aria-describedby="basic-addon1" autocomplete="off">
                        </div>
                    </div>
                    <!-- Body -->
...
<script src="<?php echo e(dynamicAsset('public/assets/admin/js/emojionearea.js')); ?>"></script>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/messages/index.blade.php ENDPATH**/ ?>