<?php $__env->startSection('title',translate('Update_Branch')); ?>
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title text-capitalize"><i class="tio-edit"></i> <?php echo e(translate('messages.Business_Zone_update')); ?></h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="zone-setup-instructions">
                                ...
                                <div class="zone-setup-item">
                                    ...
                                    <div class="info">
                                        <?php echo e(translate('messages.Use this ‘Shape Tool’ to point out the areas and connect the dots. A minimum of 3 points/dots is required.')); ?>
                        ...
                        <div class="col-md-6 col-xl-7 zone-setup">
                            ...
                            <div class="form-group lang_form" id="default-form">
                                ...
                                <input type="text" name="name[]" class="form-control" placeholder="<?php echo e(translate('messages.Type_new_zone_name_here')); ?>" maxlength="191" value="<?php echo e($zone?->getRawOriginal('name')); ?>"   >
                            </div>
                            ...
                            <div class="form-group d-none lang_form" id="<?php echo e($lang); ?>-form">
                                ...
                                <input type="text" name="name[]" class="form-control" placeholder="<?php echo e(translate('messages.Type_new_zone_name_here')); ?>" maxlength="191" value="<?php echo e($translate[$lang]['name']??''); ?>"  >
                            </div>
                        ...
                        <?php endif; ?>
                            <div class="form-group mb-3 initial-hidden">
                                <label class="input-label"
                                        ...
                                        class="input-label-secondary" title="<?php echo e(translate('messages.draw_your_zone_on_the_map')); ?>"><?php echo e(translate('messages.draw_your_zone_on_the_map')); ?></span></label>
                                        <textarea  type="text" name="coordinates"  id="coordinates" class="form-control">
                                            <?php $__currentLoopData = $area['coordinates']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$coords): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(count($area['coordinates']) != $key+1) {if($key != 0) echo(','); ?>(<?php echo e($coords[1]); ?>, <?php echo e($coords[0]); ?>)
                                            <?php } ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </textarea>
                            </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/zone/edit.blade.php ENDPATH**/ ?>