<?php $__env->startSection('title',translate('messages.restaurant_qr_code')); ?>
            ...
            <div class="card-body">
                <div class="qr-area row gy-4">
                    <div class="col-lg-6 col-xl-5 left-side">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="btn--container flex-nowrap print-btn-grp">
                                <a type="button" href="<?php echo e(route('vendor.shop.qr-print')); ?>" class="btn btn-primary pt-1"><i class="tio-print"></i> <?php echo e(translate('Print')); ?></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-xl-7 right-side">
                        <form method="post" action="<?php echo e(route('vendor.shop.qr-store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
<?php echo $__env->make('layouts.vendor.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/vendor-views/shop/qrcode.blade.php ENDPATH**/ ?>