                    ...
                    <form >
                        ...
                        <div class="input--group input-group input-group-merge input-group-flush">
                            <input id="datatableSearch_" type="search" name="search" class="form-control" value="<?php echo e(request()?->search ?? null); ?>"
                                    placeholder="<?php echo e(translate('Ex:_Search_by_name')); ?>" aria-label="Search" required>
                    ...
                    <div class="d-sm-flex justify-content-sm-end align-items-sm-center ml-0 mr-0">
                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-sm btn-white" href="javascript:;"
                                ...
                                <i class="tio-table mr-1"></i> <?php echo e(translate('messages.columns')); ?> <span
                            ...
                            <div id="showHideDropdown"
                                ...
                                <div class="card card-sm">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <span class="mr-2"><?php echo e(translate('messages.contact_info')); ?></span>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <span class="mr-2"><?php echo e(translate('messages.total_order')); ?></span>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <span class="mr-2"><?php echo e(translate('messages.active')); ?>/<?php echo e(translate('messages.inactive')); ?></span>
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th class="table-column-pl-0"><?php echo e(translate('messages.name')); ?></th>
                        <th><?php echo e(translate('messages.contact_info')); ?></th>
                        <th><?php echo e(translate('messages.Total_Delivered_Orders')); ?></th>
                        <th class="text-center"><?php echo e(translate('messages.active')); ?>/<?php echo e(translate('messages.inactive')); ?></th>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox<?php echo e($customer->id); ?>">
                                        <input type="checkbox" data-url="<?php echo e(route('admin.customer.status', [$customer->id, $customer->status ? 0 : 1])); ?>" data-message="<?php echo e($customer->status? translate('messages.you_want_to_block_this_customer'): translate('messages.you_want_to_unblock_this_customer')); ?>"
                            ...
                            <td>
                                <div class="btn--container">
                                    <a class="btn btn-sm btn--warning btn-outline-warning action-btn"
                                        href="<?php echo e(route('admin.customer.view',[$customer['id']])); ?>" title="<?php echo e(translate('messages.view_customer')); ?>"><i class="tio-visible-outlined"></i>
                                    </a>
                                </div>
                            </td>
                        </tr>
...
<?php $__env->startPush('script_2'); ?>
    <script>
        ...
        function status_change_alert(url, message, e) {
            e.preventDefault();
            Swal.fire({
                title: '<?php echo e(translate('Are_you_sure_?')); ?>',
                text: message,
                type: 'warning',
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/customer/list.blade.php ENDPATH**/ ?>