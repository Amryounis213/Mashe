            ...
            <div class="tab-pane fade show active" id="business-setup">
                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border blue-border rounded align-items-center">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="<?php echo e(translate('Want_to_enable_the_Maintenance_Mode!')); ?>"
                                data-title-off="<?php echo e(translate('Want_to_disable_the_Maintenance_Mode!')); ?>"
                                data-text-on="<p><?php echo e(translate('If_enabled,_all_your_apps_and_customer_website_will_be_temporarily_off.')); ?></p>"
                                data-text-off="<p><?php echo e(translate('If_disabled,_all_your_apps_and_customer_website_will_be_functional.')); ?></p>"
                                class="status toggle-switch-input  <?php echo e(env('APP_MODE') == 'demo' ? 'maintenance-mode': 'dynamic-checkbox'); ?> "
                ...
                <form action="<?php echo e(route('admin.business-settings.update-setup')); ?>" method="post"
                    ...
                    <h4 class="card-title mb-3 mt-1">
                        <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/company.png')); ?>" class="card-header-icon mr-2" alt="">
                                    ...
                                    <div class="d-flex __gap-12px mt-4">
                                        <label class="__custom-upload-img mr-lg-5">
                                            ...
                                            <div class="text-center">
                                                    ...
                                                    src="<?php echo e(\App\CentralLogics\Helpers::onerror_image_helper($logo, dynamicStorage('storage/app/public/business/'.$logo), dynamicAsset('public/assets/admin/img/upload-img.png'), 'business/')); ?>"
                                                    data-onerror-image="<?php echo e(dynamicAsset('public/assets/admin/img/upload-img.png')); ?>" alt="image">
                                        ...
                                        <label class="__custom-upload-img">
                                            ...
                                            <div class="text-center">
                                                    ...
                                                    src="<?php echo e(\App\CentralLogics\Helpers::onerror_image_helper($icon, dynamicStorage('storage/app/public/business/'.$icon), dynamicAsset('public/assets/admin/img/upload-img.png'), 'business/')); ?>"
                                                    data-onerror-image="<?php echo e(dynamicAsset('public/assets/admin/img/upload-img.png')); ?>" alt="Fav icon">
                                            </div>
                        ...
                        <div class="card-body pb-0">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="timezone" class="form-control js-select2-custom">
                                            ...
                                            <option value="Etc/Greenwich" <?php echo e($tz ? ($tz == 'Etc/Greenwich' ? 'selected' : '') : ''); ?>> (GMT+00:00) Greenwich Mean Time : Dublin, Edinburgh, Lisbon</option>
                                            <option value="Europe/London" <?php echo e($tz ? ($tz == 'Europe/London' ? 'selected' : '') : ''); ?>> (GMT+00:00) London</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-5">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label"><?php echo e(translate('copy_right_text')); ?> <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>" title="<?php echo e(translate('make_visitors_aware_of_your_business‘s_rights_&_legal_information')); ?>" data-toggle="tooltip" alt=""> </label>
                                ...
                                <div class="col-sm-6 col-md-5">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label"><?php echo e(translate('Cookies_Text')); ?> <img src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>" data-original-title="<?php echo e(translate('messages.make_visitors_aware_of_your_business‘s_rights_&_legal_information.')); ?>" data-toggle="tooltip" alt=""> </label>
                                        <textarea type="text" value="" name="cookies_text" class="form-control"
                                            placeholder="<?php echo e(translate('messages.Ex_:_Cookies_Text')); ?> " rows="3" required><?php echo e($cookies_text->value ?? ''); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <label class="input-label text-capitalize d-inline-flex alig-items-center">
                                                ...
                                                <span data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If the order amount exceeds this amount the delivery fee will be free and the delivery fee will be deducted from the admin’s commission.')); ?>" class="input-label-secondary"><img src="<?php echo e(dynamicAsset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.Set_a_minimum_order_value_for_free_delivery._If_someone’s_order_value_reaches_this_point,_he_will_get_a_free_delivery,_and_the_delivery_fee_will_be_deducted_from_Admin’s_commission_and_added_to_the_Admin’s_expense')); ?>"></span>
                                            </label>
                                            <label class="toggle-switch toggle-switch-sm" data-toggle="modal" data-target="#free-delivery-modal">
                                                <input type="checkbox" name="free_delivery_over_status"
                                                    ...
                                                    data-type="toggle"
                                                    data-image-on="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/tax-on.png')); ?>"
                                                    data-image-off="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/tax-off.png')); ?>"
                                                    data-title-on="<?php echo e(translate('Want_to_enable')); ?> <strong><?php echo e(translate('Free_Delivery')); ?></strong> <?php echo e(translate('on_Minimum_Orders')); ?> ?"
                                                    data-title-off="<?php echo e(translate('Want_to_disable')); ?> <strong><?php echo e(translate('Free_Delivery')); ?> <?php echo e(translate('on_Minimum_Orders')); ?></strong> ?"
                                                    data-text-on="<p><?php echo e(translate('If_enabled,_customers_can_get_FREE_Delivery_by_ordering_above_the_minimum_order_requirement')); ?></p>"
                                                    data-text-off="<p><?php echo e(translate('If_disabled,_the_FREE_Delivery_option_will_be_hidden_from_the_Customer_App_or_Website.')); ?></p>"
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="pr-2 d-flex align-items-center"><span class="line--limit-1"><?php echo e(translate('Veg_/_Non_Veg_Option')); ?></span><span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If_enabled,_customers_can_filter_food_according_to_their_preference_from_the_Customer_App_or_Website.')); ?>">
                                            ...
                                            data-title-on="<?php echo e(translate('Want_to_enable_the')); ?> <strong><?php echo e(translate('Veg/Non_Veg')); ?></strong> <?php echo e(translate('Option')); ?> ?"
                                            data-title-off="<?php echo e(translate('Want_to_disable_the')); ?> <strong><?php echo e(translate('Veg/Non_Veg')); ?> <?php echo e(translate('Option')); ?></strong> ?"
                                            data-text-on="<p><?php echo e(translate('If_enabled,_customers_can_filter_food_items_by_choosing_food_from_the_Veg/Non-Veg_option')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('If_disabled,_the_Veg/Non-Veg_option_will_be_hidden_in_both_the_Restaurant_panel_&_App_and_Website')); ?></p>"
                                            class="status toggle-switch-input dynamic-checkbox-toggle"
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <i class="tio-info-outined"></i>
                                            ...
                                            data-text-on="<p><?php echo e(translate('If_enabled,_the_commission_based_restaurant_business_model_option_will_be_available_for_this_restaurant')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('If_disabled,_the_commission_based_restaurant_business_model_option_will_be_hidden_from_this_restaurant_panel._And_it_can_only_use_the_subscription_based_business_model')); ?></p>"
                                            class="status toggle-switch-input dynamic-checkbox-toggle"
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <i class="tio-info-outined"></i>
                                            ...
                                            data-text-on="<p><?php echo e(translate('If_enabled,_the_subscription_based_restaurant_business_model_option_will_be_available_in_this_restaurant')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('If_disabled,_the_subscription_based_restaurant_business_model_option_will_be_hidden_from_this_restaurant_panel._The_existing_subscribed_restaurants’_subscriptions_will_be_valid_till_the_packages_expire')); ?></p>"
                                            class="status toggle-switch-input dynamic-checkbox-toggle"
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="pr-2 d-flex align-items-center"><span class="line--limit-1"><?php echo e(translate('messages.Include_TAX_Amount')); ?></span><span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('messages.If_enabled,_the_customer_will_see_the_total_food_price,_including_VAT/TAX._If_it’s_disabled,_the_VAT/TAX_will_be_calculated_separately_from_the_total_cost_of_the_food,_and_he_can_see_a_separate_VAT/TAX_amount_on_the_invoice')); ?>">
                                            ...
                                            data-image-on="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/tax-on.png')); ?>"
                                            data-image-off="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/tax-off.png')); ?>"
                                            data-title-on="<?php echo e(translate('Want_to_Enable')); ?> <strong><?php echo e(translate('Tax_Amount')); ?> </strong> ?"
                                            data-title-off="<?php echo e(translate('Want_to_disable')); ?> <strong><?php echo e(translate('Tax_Amount')); ?></strong> ?"
                                            data-text-on="<p><?php echo e(translate('If_enabled,_customers_will_see_the_food_Price_added_with_Tax')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('If_disabled,_customers_will_see_the_food_price_without_Tax')); ?></p>"
                                            class="status toggle-switch-input dynamic-checkbox-toggle"
                                            name="tax_included"
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="pr-2 d-flex align-items-center">
                                            ...
                                            data-type="toggle"
                                            data-image-on="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/order-notification-on.png')); ?>"
                                            data-image-off="<?php echo e(dynamicAsset('/public/assets/admin/img/modal/order-notification-off.png')); ?>"
                                            data-title-on="<?php echo e(translate('Want_to_enable')); ?> <strong><?php echo e(translate('Order_Notification_for_Admin')); ?></strong> ?"
                                            data-title-off="<?php echo e(translate('Want_to_disable')); ?> <strong><?php echo e(translate('Order_Notification_for_Admin')); ?></strong> ?"
                                            data-text-on="<p><?php echo e(translate('If_enabled,_the_Admin_will_receive_a_Notification_for_every_order_placed_by_customers')); ?></p>"
                                            data-text-off="<p><?php echo e(translate('If_disabled,_the_Admin_will_NOT_receive_any_Notification_for_any_order_placed_by_customers')); ?></p>"
                                            class="status toggle-switch-input dynamic-checkbox-toggle"  >
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('messages.Set_the_method(s)_that_customers_can_pay_the_remainder_after_partial_payment.')); ?>" alt="">
                                            <img src="<?php echo e(dynamicAsset('public/assets/admin/img/info-circle.svg')); ?>" alt="">
                                        </span>
                                        </span>
                                    </label>
                                        <div class="resturant-type-group border">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <label class="toggle-switch toggle-switch-sm" data-toggle="modal" data-target="#free-delivery-modal">
                                                <input type="checkbox" name="free_delivery_distance_status"
                                                    ...
                                                    data-title-on="<?php echo e(translate('Want_to_enable')); ?> <strong><?php echo e(translate('Free_Delivery')); ?></strong> <?php echo e(translate('on_Minimum_Distance')); ?> ?"
                                                    data-title-off="<?php echo e(translate('Want_to_disable')); ?> <strong><?php echo e(translate('Free_Delivery')); ?> <?php echo e(translate('on_Minimum_Distance')); ?></strong> ?"
                                                    data-text-on="<p><?php echo e(translate('If_enabled,_customers_can_get_FREE_Delivery_by_ordering_above_the_minimum_order_requirement')); ?></p>"
                                                    data-text-off="<p><?php echo e(translate('If_disabled,_the_FREE_Delivery_option_will_be_hidden_from_the_Customer_App_or_Website.')); ?></p>"
                                                    class="status toggle-switch-input dynamic-checkbox-toggle"
                                                    value="1"
                            ...
                            <div class="btn--container justify-content-end">
                                ...
                                class="btn btn--primary mb-2 call-demo"><i class="tio-save-outlined mr-2"></i><?php echo e(translate('messages.save_info')); ?></button>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/business-settings/business-index.blade.php ENDPATH**/ ?>