<?php $__env->startSection('title',translate('Add_new_Vehicle')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('admin.vehicle.store')); ?>" method="post" enctype="multipart/form-data" id="vehicle-form">
                    <?php echo csrf_field(); ?>
...
<?php $__env->startPush('script_2'); ?>
    <script>
        ...
        $('#vehicle-form').on('submit', function (e) {
            ...
            $.post({
                url: '<?php echo e(route('admin.vehicle.store')); ?>',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.errors) {
                        ...
                        toastr.success('<?php echo e(translate('messages.Vehicle_created')); ?>', {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setTimeout(function () {
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/admin-views/vehicle/index.blade.php ENDPATH**/ ?>