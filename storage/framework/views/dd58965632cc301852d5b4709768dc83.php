...
<?php $__env->startSection('title', $landing_data['business_name'] ); ?>
<?php $__env->startSection('content'); ?>

    <!-- ======= Footer Section ======= -->
    <!-- ======= Banner Section ======= -->
    <section class="banner-section"
        style="background: url('<?php echo e(dynamicStorage('storage/app/public/header_image')); ?>/<?php echo e($landing_data['header_bg_image']); ?>') no-repeat center center / cover">
        ...
        <div class="container">
            <div class="banner-wrapper">
                <div class="banner-thumb wow fadeInUp">
                    <img class="main-img"
                    src="<?php echo e(dynamicStorage('storage/app/public/header_image')); ?>/<?php echo e($landing_data['header_content_image']); ?>"

                    alt="">
                    <div class="img-data-1">
                        <img src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/img/banner/icon-1.png')); ?>" alt="Review">
                        <span><?php echo e(translate('Review')); ?> <?php echo e($landing_data['header_floating_total_reviews']); ?> +</span>
                    </div>
                    <div class="img-data-2">
                        <img src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/img/banner/icon-2.png')); ?>" alt="Order">
                        <span><?php echo e(translate('Order')); ?> <?php echo e($landing_data['header_floating_total_order']); ?> +</span>
                    </div>
                    <div class="img-data-3">
                        <img src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/img/banner/icon-3.png')); ?>" alt="User">
                        <span><?php echo e(translate('User')); ?> <?php echo e($landing_data['header_floating_total_user']); ?> +</span>
                    </div>
                </div>
                <div class="banner-content wow fadeInRight">
                    <h2 class="title"> <?php echo e($landing_data['header_title']); ?></h2>
                    <h3 class="subtitle"><?php echo e($landing_data['header_sub_title']); ?></h3>
                    <h1 class="name"><?php echo e($landing_data['business_name']); ?></h1>
                     <div class="txt">
                        <?php echo e($landing_data['header_tag_line']); ?>

                    </div>
                    <?php if($landing_data['header_app_button_status']): ?>
                   <a href="<?php echo e($landing_data['header_button_redirect_link']  ??  '#'); ?>"
                    class="btn-base btn-sm">
                        <span><?php echo e($landing_data['header_app_button_name']); ?></span>
        ...
        <!-- Shape 1 -->
        <div class="shape-1"><img src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/img/banner/1.png')); ?>" alt=""></div>
        <div class="shape-2"><img src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/img/banner/2.png')); ?>" alt=""></div>
        <div class="shape-3"><img src="<?php echo e(dynamicAsset('/public/assets/landing/assets_new/img/banner/3.png')); ?>" alt=""></div>
        <!-- Glass 1 -->
    ...
    <!-- ======= Banner Section ======= -->
    <!-- ======= About Section ======= -->
    <?php if(isset($landing_data['about_us_title']) && (isset($landing_data['about_us_sub_title']) || isset($landing_data['about_us_text']) || isset($landing_data['about_us_image_content']) )): ?>
            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-7">
                    <div class="about-content wow fadeInDown">
                        <h2 class="title text-base"><?php echo e($landing_data['about_us_title']); ?></h2>
                        <h3 class="subtitle"><?php echo e($landing_data['about_us_sub_title']); ?></h3>
                        <p class="txt">
                            <?php echo e($landing_data['about_us_text']); ?>

                        </p>
                        <?php if($landing_data['about_us_app_button_status'] &&  $landing_data['about_us_app_button_name'] ): ?>
                        <a href="<?php echo e($landing_data['about_us_redirect_link'] ?? '#'); ?>" class="btn-base btn-sm">
                            <span>
                                <?php echo e($landing_data['about_us_app_button_name']); ?>
                ...
                <div class="col-lg-5 text-lg-end text-center wow fadeInLeft">
                    <img
                    src="<?php echo e(dynamicStorage('storage/app/public/about_us_image')); ?>/<?php echo e($landing_data['about_us_image_content']); ?>"
    ...
    <?php if(isset($landing_data['features']) && count($landing_data['features']) > 0): ?>
    <section class="feature-section overflow-hidden pt-80">
        <div class="container">
            <div class="section-header text-center wow fadeInUp">
                <h2 class="title">
                        <span class="text-base"><?php echo e($landing_data['feature_title']); ?></span>
                </h2>
                <p>
                    <?php echo e($landing_data['feature_sub_title']); ?>

                </p>
            </div>
            <div class="feature-slider owl-theme owl-carousel">
                <?php $__currentLoopData = $landing_data['features']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="feature-item wow fadeInUp">
                    <div class="feature-item-icon">
                        <img
                        src="<?php echo e(dynamicStorage('storage/app/public/feature_image')); ?>/<?php echo e($feature_data['image']); ?>" alt="">
                    </div>
                    <h4 class="title"><?php echo e($feature_data['title']); ?></h4>
                    <div class="txt">
                        <?php echo e($feature_data['description']); ?>
    ...
    <?php endif; ?>
    <!-- ======= Feature Section ======= -->
    <?php if(isset($landing_data['services_title']) && (
    ...
    <section class="platform-section pt-80 overflow-hidden">
        <div class="container">
            <div class="section-header text-center wow fadeInUp">
                <h2 class="title">
                    <span class="text-base"><?php echo e($landing_data['services_title']); ?></span>
                </h2>
                <p>
                    <?php echo e($landing_data['services_sub_title']); ?>
            ...
            <ul class="nav nav-tabs nav--tabs wow fadeInUp">
               <?php if(isset($landing_data['services_order_title_1'] ) || isset($landing_data['services_order_title_2'] )): ?>
               <li>
                   <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#order-your-food">
                       <img src="<?php echo e(dynamicAsset('public/assets/admin/img/order_platform_image.png')); ?>" alt="">
                    
                       <?php echo e(translate('Order_your_food')); ?>

                   </button>
               </li>
               <?php endif; ?>

                <?php if(isset($landing_data['services_manage_restaurant_title_1'] ) || isset($landing_data['services_manage_restaurant_title_2'] )): ?>
                <li>
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#manage-restaurant">
                        <img  src="<?php echo e(dynamicAsset('public/assets/admin/img/manage_your_restaurant.png')); ?>"
                        alt="">
                        <?php echo e(translate('manage_your_restaurant')); ?>

                    </button>
                </li>
                <?php endif; ?>
                <?php if(isset($landing_data['services_manage_delivery_title_2'] ) || isset($landing_data['services_manage_delivery_title_1'] )): ?>
                <li>
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#earn-delivery">
                        <img src="<?php echo e(dynamicAsset('public/assets/admin/img/earn_by_delivery.png')); ?>"
                        alt="">
                        <?php echo e(translate('earn_by_delivery')); ?>
            ...
            <div class="tab-content tab--content">
                    ...
                    <div class="row gy-5 align-items-center flex-wrap-reverse">
                        <div class="col-lg-7">
                            <div class="platform-content wow fadeInUp">
                                ...
                                <h4 class="subtitle"><?php echo e($landing_data['services_order_title_1']); ?></h4>
                                <p>
                                    <?php echo e($landing_data['services_order_description_1']); ?>

                                </p>

                                <h4 class="subtitle"><?php echo e($landing_data['services_order_title_2']); ?></h4>
                                <p>
                                    <?php echo e($landing_data['services_order_description_2']); ?>

                                </p>


                               <?php if($landing_data['services_order_button_status'] ==1 ): ?>
                                <a href="<?php echo e($landing_data['services_order_button_link']  ??'#'); ?>" class="btn-base btn-sm">
                                    <span><?php echo e($landing_data['services_order_button_name']); ?></span>
                                    <svg width="14" height="15" viewBox="0 0 14 15" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M0.875 7.50006C0.875 7.38403 0.921094 7.27275 1.00314 7.19071C1.08519 7.10866 1.19647 7.06256 1.3125 7.06256H11.6314L8.87775 4.30981C8.7956 4.22766 8.74945 4.11624 8.74945 4.00006C8.74945 3.88389 8.7956 3.77247 8.87775 3.69031C8.9599 3.60816 9.07132 3.56201 9.1875 3.56201C9.30368 3.56201 9.4151 3.60816 9.49725 3.69031L12.9972 7.19031C13.038 7.23095 13.0703 7.27923 13.0924 7.33239C13.1144 7.38554 13.1258 7.44252 13.1258 7.50006C13.1258 7.55761 13.1144 7.61459 13.0924 7.66774C13.0703 7.7209 13.038 7.76917 12.9972 7.80981L9.49725 11.3098C9.4151 11.392 9.30368 11.4381 9.1875 11.4381C9.07132 11.4381 8.9599 11.392 8.87775 11.3098C8.7956 11.2277 8.74945 11.1162 8.74945 11.0001C8.74945 10.8839 8.7956 10.7725 8.87775 10.6903L11.6314 7.93756H1.3125C1.19647 7.93756 1.08519 7.89147 1.00314 7.80942C0.921094 7.72738 0.875 7.6161 0.875 7.50006Z"
                    ...
                    <div class="row gy-5 align-items-center flex-wrap-reverse">
                        <div class="col-lg-7">
                            <div class="platform-content">
                                <h4 class="subtitle"><?php echo e($landing_data['services_manage_restaurant_title_1']); ?></h4>
                                <p>
                                    <?php echo e($landing_data['services_manage_restaurant_description_1']); ?>

                                </p>

                                <h4 class="subtitle"><?php echo e($landing_data['services_manage_restaurant_title_2']); ?></h4>
                                <p>
                                    <?php echo e($landing_data['services_manage_restaurant_description_2']); ?>

                                </p>
                                <?php if($landing_data['services_manage_restaurant_button_status'] ==1 ): ?>
                                <a href="<?php echo e($landing_data['services_manage_restaurant_button_link']  ?? '#'); ?>"class="btn-base btn-sm">
                                    <span><?php echo e($landing_data['services_manage_restaurant_button_name']); ?></span>
                                    <svg width="14" height="15" viewBox="0 0 14 15" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M0.875 7.50006C0.875 7.38403 0.921094 7.27275 1.00314 7.19071C1.08519 7.10866 1.19647 7.06256 1.3125 7.06256H11.6314L8.87775 4.30981C8.7956 4.22766 8.74945 4.11624 8.74945 4.00006C8.74945 3.88389 8.7956 3.77247 8.87775 3.69031C8.9599 3.60816 9.07132 3.56201 9.1875 3.56201C9.30368 3.56201 9.4151 3.60816 9.49725 3.69031L12.9972 7.19031C13.038 7.23095 13.0703 7.27923 13.0924 7.33239C13.1144 7.38554 13.1258 7.44252 13.1258 7.50006C13.1258 7.55761 13.1144 7.61459 13.0924 7.66774C13.0703 7.7209 13.038 7.76917 12.9972 7.80981L9.49725 11.3098C9.4151 11.392 9.30368 11.4381 9.1875 11.4381C9.07132 11.4381 8.9599 11.392 8.87775 11.3098C8.7956 11.2277 8.74945 11.1162 8.74945 11.0001C8.74945 10.8839 8.7956 10.7725 8.87775 10.6903L11.6314 7.93756H1.3125C1.19647 7.93756 1.08519 7.89147 1.00314 7.80942C0.921094 7.72738 0.875 7.6161 0.875 7.50006Z"
                ...
                <div class="tab-pane fade show" id="earn-delivery">
                    <div class="row gy-5 align-items-center flex-wrap-reverse">
                        <div class="col-lg-7">
                            <div class="platform-content">
                                <h4 class="subtitle"><?php echo e($landing_data['services_manage_delivery_title_1']); ?></h4>
                                <p>
                                    <?php echo e($landing_data['services_manage_delivery_description_1']); ?>

                                </p>

                                <h4 class="subtitle"><?php echo e($landing_data['services_manage_delivery_title_2']); ?></h4>
                                <p>
                                    <?php echo e($landing_data['services_manage_delivery_description_2']); ?>

                                </p>
                                <?php if($landing_data['services_manage_delivery_button_status'] ==1 ): ?>
                                <a href="<?php echo e($landing_data['services_manage_delivery_button_link']  ??  '#'); ?>"class="btn-base btn-sm">
                                    <span><?php echo e($landing_data['services_manage_delivery_button_name']); ?></span>
                                    <svg width="14" height="15" viewBox="0 0 14 15" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M0.875 7.50006C0.875 7.38403 0.921094 7.27275 1.00314 7.19071C1.08519 7.10866 1.19647 7.06256 1.3125 7.06256H11.6314L8.87775 4.30981C8.7956 4.22766 8.74945 4.11624 8.74945 4.00006C8.74945 3.88389 8.7956 3.77247 8.87775 3.69031C8.9599 3.60816 9.07132 3.56201 9.1875 3.56201C9.30368 3.56201 9.4151 3.60816 9.49725 3.69031L12.9972 7.19031C13.038 7.23095 13.0703 7.27923 13.0924 7.33239C13.1144 7.38554 13.1258 7.44252 13.1258 7.50006C13.1258 7.55761 13.1144 7.61459 13.0924 7.66774C13.0703 7.7209 13.038 7.76917 12.9972 7.80981L9.49725 11.3098C9.4151 11.392 9.30368 11.4381 9.1875 11.4381C9.07132 11.4381 8.9599 11.392 8.87775 11.3098C8.7956 11.2277 8.74945 11.1162 8.74945 11.0001C8.74945 10.8839 8.7956 10.7725 8.87775 10.6903L11.6314 7.93756H1.3125C1.19647 7.93756 1.08519 7.89147 1.00314 7.80942C0.921094 7.72738 0.875 7.6161 0.875 7.50006Z"
    ...
    <!-- ======= Platform Section ======= -->
    <?php endif; ?>
    <?php if(isset($landing_data['why_choose_us_title']) && (isset($landing_data['why_choose_us_image_1']) || isset($landing_data['why_choose_us_image_2']) || isset($landing_data['why_choose_us_image_3']) || isset($landing_data['why_choose_us_image_4']))): ?>
    <!-- ======= Choose Section ======= -->
    <section class="choose-section overflow-hidden pt-80">
        <div class="container">
            <div class="section-header text-center wow fadeInUp">
                <h2 class=" title">
                    <span class="text-base">  <?php echo e($landing_data['why_choose_us_title']); ?>

                    </span>
                </h2>
                <p>
                    <?php echo e($landing_data['why_choose_us_sub_title']); ?>

                </p>
            </div>
            <div class="choose-wrapper">
                
            <?php if(isset($landing_data['why_choose_us_image_1'])): ?>

                <div class="choose-item wow animate__dropIn">
                                <img
                    src="<?php echo e(dynamicStorage('storage/app/public/why_choose_us_image')); ?>/<?php echo e($landing_data['why_choose_us_image_1']); ?>"
                    alt="Image">
                    <div class="choose-item-content">
                        <div class="cont">
                            <h4 class="title">
                                <?php echo e($landing_data['why_choose_us_title_1']); ?>
            ...
            <?php endif; ?>
            <?php if(isset($landing_data['why_choose_us_image_2'])): ?>

                <div class="choose-item wow animate__dropIn">
                                <img
                    src="<?php echo e(dynamicStorage('storage/app/public/why_choose_us_image')); ?>/<?php echo e($landing_data['why_choose_us_image_2']); ?>"
                    alt="Image">
                    <div class="choose-item-content">
                        <div class="cont">
                            <h4 class="title">
                                <?php echo e($landing_data['why_choose_us_title_2']); ?>
            ...
            <?php endif; ?>
            <?php if(isset($landing_data['why_choose_us_image_3'])): ?>

                <div class="choose-item wow animate__dropIn">
                                <img
                    src="<?php echo e(dynamicStorage('storage/app/public/why_choose_us_image')); ?>/<?php echo e($landing_data['why_choose_us_image_3']); ?>"
                    alt="Image">
                    <div class="choose-item-content">
                        <div class="cont">
                            <h4 class="title">
                                <?php echo e($landing_data['why_choose_us_title_3']); ?>
            ...
            <?php endif; ?>
            <?php if(isset($landing_data['why_choose_us_image_4'])): ?>
                <div class="choose-item wow animate__dropIn">
                                <img
                    src="<?php echo e(dynamicStorage('storage/app/public/why_choose_us_image')); ?>/<?php echo e($landing_data['why_choose_us_image_4']); ?>"
                    alt="Image">
                    <div class="choose-item-content">
                        <div class="cont">
                            <h4 class="title">
                                <?php echo e($landing_data['why_choose_us_title_4']); ?>
    ...
    <?php endif; ?>
    <!-- ======= Choose Section ======= -->
    <?php if(isset($landing_data['earn_money_title']) ): ?>
    <!-- ======= Lets Start Section ======= -->
    <section class="lets-start-section pt-80 pb-80">
        <div class="container">
            <div class="section-header text-center wow fadeInUp">
                <h2 class="title mb-lg-5">
                    <span class="text-base">  <?php echo e($landing_data['earn_money_title']); ?>

                    </span>
                    </h2>
                <p>
                    <?php echo e($landing_data['earn_money_sub_title']); ?>
    ...
    <!-- ======= Lets Start Section ======= -->
    <?php endif; ?>
    <?php if(isset($landing_data['earn_money_reg_title']) || isset($landing_data['earn_money_reg_image'])  ): ?>
        ...
        <div class="container">
            <div class="row align-items-end justify-content-end">
                <div class="col-md-6">
                    <div class="cta-content wow fadeInUp">
                        <div class="section-header ms-0">
                            <h2 class="title">
                                <?php echo e($landing_data['earn_money_reg_title']); ?>

                            </h2>
                        </div>
                        <div class="cta-btn-container d-flex flex-wrap">
                            <?php if($landing_data['earn_money_restaurant_req_button_status'] ): ?>
                            <a href="<?php echo e($landing_data['earn_money_restaurant_req_button_link'] ?? '#'); ?>" class="btn-base">
                                <span> <?php echo e($landing_data['earn_money_restaurant_req_button_name']); ?></span>
                                <svg width="14" height="15" viewBox="0 0 14 15" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <?php endif; ?>
                            <?php if($landing_data['earn_money_delivery_man_req_button_status'] ): ?>
                            <a href="<?php echo e($landing_data['earn_money_delivery_req_button_link'] ?? '#'); ?>" class="btn-base">
                                <span><?php echo e($landing_data['earn_money_delivety_man_req_button_name']); ?></span>
                                <svg width="14" height="15" viewBox="0 0 14 15" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M0.875 7.67487C0.875 7.55884 0.921094 7.44756 1.00314 7.36551C1.08519 7.28346 1.19647 7.23737 1.3125 7.23737H11.6314L8.87775 4.48462C8.7956 4.40247 8.74945 4.29105 8.74945 4.17487C8.74945 4.05869 8.7956 3.94727 8.87775 3.86512C8.9599 3.78297 9.07132 3.73682 9.1875 3.73682C9.30368 3.73682 9.4151 3.78297 9.49725 3.86512L12.9973 7.36512C13.038 7.40576 13.0703 7.45404 13.0924 7.50719C13.1144 7.56034 13.1258 7.61732 13.1258 7.67487C13.1258 7.73242 13.1144 7.7894 13.0924 7.84255C13.0703 7.8957 13.038 7.94398 12.9973 7.98462L9.49725 11.4846C9.4151 11.5668 9.30368 11.6129 9.1875 11.6129C9.07132 11.6129 8.9599 11.5668 8.87775 11.4846C8.7956 11.4025 8.74945 11.291 8.74945 11.1749C8.74945 11.0587 8.7956 10.9473 8.87775 10.8651L11.6314 8.11237H1.3125C1.19647 8.11237 1.08519 8.06628 1.00314 7.98423C0.921094 7.90218 0.875 7.7909 0.875 7.67487V7.67487Z"
                ...
                <div class="col-md-5 text-center">
                    ...
                    src="<?php echo e(dynamicStorage('storage/app/public/earn_money')); ?>/<?php echo e($landing_data['earn_money_reg_image']); ?>"
                    alt="">
                </div>
            </div>
        </div>
                ...
                <div class="testimonial-item" dir="ltr">
                    <div class="position-relative">
                        ...
                        <div id="sync2" class="owl-theme owl-carousel mb-4 mb-md-5">
                            <?php $__currentLoopData = $landing_data['testimonials']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="img">
                                <img src="<?php echo e(dynamicStorage('storage/app/public/reviewer_image')); ?>/<?php echo e($data['reviewer_image']); ?>" alt="">
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.landing.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Mashe-Backend-main\resources\views/home.blade.php ENDPATH**/ ?>