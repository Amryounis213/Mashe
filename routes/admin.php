...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'restaurant', 'as' => 'restaurant.','middleware'=>['module:restaurant']], function () {
            ...
            Route::get('get-addons-ajax', 'AddOnController@getAddons')->name('get_addons_by_ajax');
            ...
            Route::group(['middleware' => ['module:restaurant']], function () {
                ...
                Route::get('menu/{id}', 'VendorController@menus')->name('menus');
                Route::get('new_menu/{id}', 'VendorController@create_menus_page')->name('create_menus_page');
                Route::post('new_menu' , 'VendorController@new_menu')->name('add_new_menu');


                Route::get('categories/{id}', 'VendorController@categories')->name('categories');
                Route::get('new_category/{id}', 'VendorController@create_category_page')->name('create_category_page');
                Route::post('new_category' , 'VendorController@add_new_category')->name('add_new_category');
         ...
         * *************************************************
         */
        Route::group(['prefix' => 'market', 'as' => 'market.','middleware'=>['module:restaurant']], function () {
            Route::get('get-markets-data/{market}', 'MarketController@get_market_data')->name('get-markets-data');
            Route::get('market-filter/{id}', 'MarketController@market_filter')->name('marketfilter');
            Route::get('get-account-data/{market}', 'MarketController@get_account_data')->name('marketfilter');
            Route::get('get-addons', 'MarketController@get_addons')->name('get_addons');
            Route::group(['middleware' => ['module:market']], function () {
                Route::get('update-application/{id}/{status}', 'MarketController@update_application')->name('application');
                Route::get('add', 'MarketController@index')->name('add');
                Route::post('store', 'MarketController@store')->name('store');
                Route::get('edit/{id}', 'MarketController@edit')->name('edit');
                Route::post('update/{market}', 'MarketController@update')->name('update');
                Route::post('discount/{market}', 'MarketController@discountSetup')->name('discount');
                Route::post('update-settings/{market}', 'MarketController@updatemarketSettings')->name('update-settings');
                // Route::delete('delete/{market}', 'MarketController@destroy')->name('delete');
                Route::delete('clear-discount/{market}', 'MarketController@cleardiscount')->name('clear-discount');
                // Route::get('view/{market}', 'MarketController@view')->name('view_tab');
                Route::get('view/{market}/{tab?}/{sub_tab?}', 'MarketController@view')->name('view');
                Route::get('pending/list', 'MarketController@pending')->name('pending');
                Route::get('denied/list', 'MarketController@denied')->name('denied');
                
                // message
                Route::get('message/{conversation_id}/{user_id}', 'MarketController@conversation_view')->name('message-view');
                Route::get('message/list', 'MarketController@conversation_list')->name('message-list');

                Route::get('list', 'MarketController@list')->name('list');


                Route::get('menu/{id}', 'MarketController@menus')->name('menus');
                Route::get('new_menu/{id}', 'MarketController@create_menus_page')->name('create_menus_page');
                Route::post('new_menu' , 'MarketController@new_menu')->name('add_new_menu');


                Route::get('categories/{id}', 'MarketController@categories')->name('categories');
                Route::get('new_category/{id}', 'MarketController@create_category_page')->name('create_category_page');
                Route::post('new_category' , 'MarketController@add_new_category')->name('add_new_category');


                Route::post('search', 'MarketController@search')->name('search');
                Route::get('status/{market}/{status}', 'MarketController@status')->name('status');
                Route::get('toggle-settings-status/{market}/{status}/{menu}', 'MarketController@market_status')->name('toggle-settings');
                Route::post('status-filter', 'MarketController@status_filter')->name('status-filter');
                //Import and export
                Route::get('bulk-import', 'MarketController@bulk_import_index')->name('bulk-import');
                Route::post('bulk-import', 'MarketController@bulk_import_data');
                Route::get('bulk-export', 'MarketController@bulk_export_index')->name('bulk-export-index');
                Route::post('bulk-export', 'MarketController@bulk_export_data')->name('bulk-export');
                Route::get('cash-transaction-export', 'MarketController@cash_transaction_export')->name('cash-transaction-export');
                Route::get('digital-transaction-export', 'MarketController@digital_transaction_export')->name('digital-transaction-export');
                Route::get('withdraw-transaction-export', 'MarketController@withdraw_transaction_export')->name('withdraw-transaction-export');
                //get all markets export
                Route::get('markets-export/{type}', 'MarketController@markets_export')->name('markets-export');
                //market shcedule
                Route::post('add-schedule', 'MarketController@add_schedule')->name('add-schedule');
                Route::get('remove-schedule/{market_schedule}', 'MarketController@remove_schedule')->name('remove-schedule');

                Route::post('update-meta-data/{market}', 'MarketController@updateStoreMetaData')->name('update-meta-data');
                Route::post('qrcode/store/{market}', 'MarketController@qr_store')->name('qrcode.store');
                Route::get('qrcode/download-pdf/{market}', 'MarketController@download_pdf')->name('qrcode.download-pdf');
                Route::get('qrcode/print/{market}', 'MarketController@print_qrcode')->name('qrcode.print');

            });

            Route::group(['middleware' => ['module:withdraw_list']], function () {
                Route::post('withdraw-status/{id}', 'MarketController@withdrawStatus')->name('withdraw_status');
                Route::get('withdraw_list', 'MarketController@withdraw')->name('withdraw_list');
                Route::post('withdraw_list/search', 'MarketController@withdraw_search')->name('withdraw_list_search');
                Route::get('withdraw-view/{withdraw_id}/{seller_id}', 'MarketController@withdraw_view')->name('withdraw_view');
                Route::get('withdraw-list-export', 'MarketController@withdraw_list_export')->name('withdraw-list-export');
            });
                Route::get('disbursement-export/{id}/{type}', 'MarketController@disbursement_export')->name('disbursement-export');

            Route::get('market-wise-reviwe-export', 'MarketController@market_wise_reviwe_export')->name('market_wise_reviwe_export');
        ...
        Route::group(['prefix' => 'zone', 'as' => 'zone.', 'middleware' => ['module:zone']], function () {
            ...
            Route::get('categories/{id}', 'ZoneCategoryController@categories')->name('categories');
            Route::get('new_category/{id}', 'ZoneCategoryController@create_category_page')->name('create_category_page');
            Route::post('new_category' , 'ZoneCategoryController@add_new_category')->name('add_new_category');
            Route::delete('destroy-category/{id}', 'ZoneCategoryController@destroy')->name('category.delete');
            Route::get('category-status/{id}/{status}', 'ZoneCategoryController@status')->name('category.status');
            Route::get('market-status/{id}/{status}', 'ZoneCategoryController@Marketstatus')->name('category.market-status');
    ...
    Route::group(['prefix' => 'country', 'as' => 'country.'], function () {
        Route::get('get-all', 'CountryController@get_all')->name('get-all');
        Route::group(['middleware' => ['module:category']], function () {
            Route::get('add', 'CountryController@index')->name('add');
            Route::get('add-sub-category', 'CountryController@sub_index')->name('add-sub-category');
            Route::get('add-sub-sub-category', 'CountryController@sub_sub_index')->name('add-sub-sub-category');
            ...
            Route::delete('delete/{id}', 'CountryController@destroy')->name('delete');
            // Route::post('search', 'CountryController@search')->name('search');
            Route::get('export-countries', 'CountryController@export_countries')->name('export-countries');

            // //Import and export
            // Route::get('bulk-import', 'CountryController@bulk_import_index')->name('bulk-import');
            // Route::post('bulk-import', 'CountryController@bulk_import_data');
            // Route::get('bulk-export', 'CountryController@bulk_export_index')->name('bulk-export-index');
            // Route::post('bulk-export', 'CountryController@bulk_export_data')->name('bulk-export');
        });
    });
});
