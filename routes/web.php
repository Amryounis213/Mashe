...
Route::group(['prefix' => 'market', 'as' => 'market.'], function () {
    Route::get('apply', 'MarketController@create')->name('create');
    Route::get('back/{restaurant_id}', 'MarketController@back')->name('back');
    Route::post('apply', 'MarketController@store')->name('store');
    Route::post('payment', 'MarketController@payment')->name('payment');
    Route::post('business-plan', 'MarketController@business_plan')->name('business_plan');
});
...
Route::get('/zones/{country_id}', [ZoneController::class, 'getZonesByCountry'])->name('zones.byCountry');

Route::post('/update-food-order', [FoodController::class, 'updateOrder']);
